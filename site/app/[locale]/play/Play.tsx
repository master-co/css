...
import LanguageButton from '~/site/docs-shell/components/LanguageButton'
import ThemeButton from '~/site/docs-shell/components/ThemeButton'
import { beautifyCSS } from '~/site/docs-shell/utils/beautify-css'
import templates from './templates'
import Resizable from '~/site/docs-shell/components/Resizable'
import { useThemeMode } from '@master/theme-mode.react'
import Header from '~/site/docs-shell/components/Header'
import HeaderNav from '~/site/docs-shell/components/HeaderNav'
...
import DocMenuButton from '~/site/docs-shell/components/DocMenuButton'
import { useTranslation } from '~/site/docs-shell/contexts/i18n'
import HeaderContent from '~/site/docs-shell/components/HeaderContent'
import { useApp } from '~/site/docs-shell/contexts/app'
    ...
    <div className="abs flex flex-col full">
      <Header fixed={false}>
        <HeaderContent>
          ...
          <ThemeButton className="app-header-icon mr:-0.75rem hidden@<md"
      ...
      <div
        className={clsx(
          'flex overflow:hidden flex:1 full background-color:transparent_:is(.monaco-editor,.monaco-editor-background,.monaco-editor_.margin) flex-col!@<md',
          {
            'flex-row': !layout,
