...
<article class="field-sizing:content interpolate-size:allow-keywords view-transition-name:card transition-behavior:allow-discrete">…</article>
```
...
<div class="interpolate-size:allow-keywords scroll-timeline-name:--cards paint-order:stroke|fill">…</div>
```
