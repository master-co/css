...
```html
<!-- @MARK mt:16 --><!-- @MARK margin:16 --><!-- @MARK bg:red-60 -->
<div class="mt:16 margin:16 bg:red-60">…</div>
```

<details>
    <summary>Generated CSS</summary>
    <Class2CSS>
        {['mt:16', 'margin:16', 'bg:red-60']}
    </Class2CSS>
</details>

This preserves the expected syntax model:

- `mt:16` uses a curated alias and emits `margin-top:16`.
- `margin:16` writes the native property value as-is and emits `margin:16`.
