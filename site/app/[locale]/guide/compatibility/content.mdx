...
Native fallback is intentionally lower priority than Master CSS semantics. Curated aliases, token resolution, unit conversion, transform helpers, and shorthand utilities continue to use the Master CSS matcher before a native declaration is considered.
...
- `margin:16` keeps Master CSS unit conversion and emits `margin:1rem`.
