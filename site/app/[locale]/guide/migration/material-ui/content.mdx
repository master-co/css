...
```html
<section class="b:1px|solid|var(--color-line-base) fg-body bg-surface r-control">
  ...
</section>
```
...
@layer components {
  .panel {
    @compose p-lg b:1px|solid|var(--color-line-base) r-lg fg-body shadow-sm bg-surface;
  }

  .toolbar {
    @compose flex items-center gap-sm min-h:3rem;
  }
}
```
