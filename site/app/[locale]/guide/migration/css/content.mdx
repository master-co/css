...
.button {
    @compose inline-flex align-items:center justify-content:center gap:xs h:10x px:md r:md bg:blue-60 fg:white;
}
...
```html
<article class="bg:surface fg:body p:card r:card grid-cols:3@md">
    ...
</article>
```
