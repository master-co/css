...
- [Theme Tokens](/guide/theme) for `@theme` tokens, [Variables and Modes](/guide/variables-and-modes) for `@settings` and modes, and [Conditional Queries](/guide/conditional-queries) for custom variants.
