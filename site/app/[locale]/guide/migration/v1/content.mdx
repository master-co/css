...
import config from './master.css?master-css-config' /* [!code ++] */
...
Deprecate extended `breakpoints` and `queries` ​​in favor of `config.variables` and `config.atTokens`.
```js name=master.css.js
import { Style } from '@master/css' /* [!code --] */
...
export default { /* [!code ++] */
    variables: [ /* [!code ++] */
        { namespace: 'screen', key: 'laptop', value: 1024 }, /* [!code ++] */
    ], /* [!code ++] */
    atTokens: { /* [!code ++] */
        watch: '>=38mm&<=42mm' /* [!code ++] */
    } /* [!code ++] */
} /* [!code ++] */
```
