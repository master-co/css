...
```
Not just media queries but feature queries and [more](/guide/at-tokens).
...
### Add media queries
Using [at tokens](/guide/at-tokens) to define media queries, feature queries, and even container queries.
```js name=tailwind.config.js
/** @type {import('tailwindcss').Config} */
module.exports = {
    theme: {
