...
```html
<section class="grid gap:lg w:full max-w:5xl mx:auto px:md py:2xl grid-cols:3@md">
...
```html
<button class="inline-flex items-center h:10x px:md r:md bg:blue-60 fg:white bg:blue-70:hover opacity:.5:disabled">
  Save
</button>
```
...
function Progress({ value }: { value: number }) {
  return (
    <div className="overflow:hidden h:4x r:full bg:gray-10">
      <div
