...
```html
<section class="w:100% max-w-6xl mx:auto px-md py-2xl">
  <div class="grid gap-lg grid-cols:3@md">
    <article class="p-lg b:1px|solid|var(--color-line-base) r-lg bg-white">
      ...
    </article>
  </div>
</section>
...
@components {
  btn-primary {
    @compose inline-flex items-center justify-center gap-xs h:2.5rem px-md bg-primary fg-white r-control;
    &:hover { @compose bg-blue-70; }
    &:disabled { opacity: 0.5; }
  }

  panel {
    @compose p-lg b:1px|solid|var(--color-line-base) r-lg bg-white fg-body shadow-sm;
  }
}
```
