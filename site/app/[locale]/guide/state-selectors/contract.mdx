...
<input id="contact-email" type="email" required
  class="b:1px|solid b-green:valid b-red:invalid outline:2px|solid|var(--color-blue):focus-visible" />
```
...
<!-- @MARK :checked -->
<label>
  <input class="outline:2px|solid|var(--color-blue):checked" type="checkbox" checked />
...
<div tabindex="0" role="region" aria-label="Scrollable schedule"
  class="overflow-x:auto max-w:100% size:0.375rem::scrollbar bg-neutral-50/.2::scrollbar-thumb">
