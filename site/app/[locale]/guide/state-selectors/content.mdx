...
<Demo>
    <button className="bg:blue-60 bg:blue-70:hover bg:blue-80:active px:md h:10x font:sm font:medium text:white r:sm inline-flex align-items:center">Submit</button>
</Demo>
```html
<!-- @MARK :hover --><!-- @MARK :active -->
    ...
    <DemoPanel $p={0} className="w:full max-w:90x">
        <ul className="list-style:none py:lg px:0 m:0">
            {furnitures.map((furniture, index) =>
                <li className="bb:0:last bg:slate-5:even@light bg:gray-90:even@dark bb:1px|solid|gray-20 px:lg flex align-items:center my:0 gap:sm" key={index}>
                    ...
                    <div className="flex flex-col flex:1 py:xs">
                        ...
                        <div className="text:xs m:0 text:gray">{furniture.intro}</div>
                    </div>
                </li>
            )}
        </ul>
...
<Demo>
    <input type="email" className="b:red:invalid b:green:valid b:1px|solid|gray-20 outline:0 h:12x font:sm px:md bg:white r:md max-w:75x" defaultValue="aron@master." />
</Demo>
```html
...
<Demo>
    <input type="checkbox" className="appearance:none bg:blue-60:checked b:1px|solid|gray-20 r:sm size:5x" defaultChecked />
</Demo>
```html
<!-- @MARK :checked -->
...
<Demo $py={0}>
    <DemoPanel>
        <q className="italic text:neutral font:lg font:medium">Be the change you wish to see in the world.</q>
    </DemoPanel>
</Demo>
```html
