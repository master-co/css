...
```html
<!-- @MARK :hover -->
<div class="text:blue-60:hover"></div>
<!-- @MARK :invalid -->
...
<Demo>
    <button className="bg:blue-60 bg:blue-70:hover bg:blue-80:active pi:md h:10x font:sm font:medium text:white r:sm inline-flex align-items:center">Submit</button>
</Demo>
```html
<!-- @MARK :hover --><!-- @MARK :active -->
<button class="bg:blue-60 text:white bg:blue-70:hover bg:blue-80:active">Submit</button>
```
                ...
                <li className="bb:0:last bg:slate-5:even@light bg:gray-90:even@dark bb:1px|solid|subtle px:lg flex align-items:center my:0 gap:sm" key={index}>
                    ...
                    <div className="flex flex-col flex:1 py:xs">
                        <div className="flex align-items:center">
                            <div className="text:sm capitalize text:strong">{furniture.name}</div>
                        </div>
                        <div className="text:xs m:0 text:text">{furniture.intro}</div>
                    </div>
                </li>
            )}
        </ul>
...
<Demo>
    <input type="checkbox" className="appearance:none bg:blue-60:checked b:1px|solid|line r:sm size:5x" defaultChecked />
</Demo>
```html
<!-- @MARK :checked -->
...
```html
<!-- @MARK :not(.active) -->
<div class="text:green-60:not(.active) active">...</div>
```
...
<Demo $py={0}>
    <DemoPanel>
        <q className="italic text:strong font:lg font:medium">Be the change you wish to see in the world.</q>
    </DemoPanel>
</Demo>
```html
