...
<Demo>
    <input type="email" className="b:red:invalid b:green:valid b:1px|solid|subtle outline:0 h:12x font:sm pi:md bg:white r:md max-w:75x" defaultValue="aron@master." />
</Demo>
```html
