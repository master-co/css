    ...
    <DemoPanel $p={0} className="w:full max-w:90x">
        <ul className="list-style:none py:lg px:0 m:0">
            {furnitures.map((furniture, index) =>
                <li className="bb:0:last bg:surface-muted:even bb:1px|solid|line px:lg flex align-items:center my:0 gap:sm" key={index}>
...
<Demo>
    <input type="email" className="b:red:invalid b:green:valid b:1px|solid|line outline:0 h:12x font:sm px:md bg:surface r:md max-w:75x" defaultValue="aron@master." />
</Demo>
```html
