...
<Demo>
    <button className="bg:blue-60 bg:blue-70:hover bg:blue-80:active px:md h:10x font:sm font:medium fg:white r:sm inline-flex align-items:center">Submit</button>
</Demo>
```html
<!-- @MARK :hover --><!-- @MARK :active -->
