...
<Demo>
    <input type="email" className="b:red:invalid b:green:valid b:1px|solid|base outline:0 h:12x font:sm px:md surface:base r:md max-w:75x" defaultValue="aron@master." />
</Demo>
```html
