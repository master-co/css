...
<StepSection className="mt:12x">
    <Step $row>
        ...
        <StepR>
            <a className="app-object app-object-interactive flex-col px:25 h:48 font:14 font:medium r:4 leading:1 flex-row!" href="vscode:extension/masterco.master-css">
