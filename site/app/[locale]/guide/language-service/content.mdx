...
- CSS files containing `@master entry;`
...
| Project variables, components, or utilities are missing. | Add a CSS entry with `@master entry;`, import `@master/css`, or declare a Master CSS package dependency, then restart the language server. |
