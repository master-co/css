...
export default () => (
    <Features className="margin-block:3xl grid-cols:3@sm">
        <Feature>
            ...
            <div>
                <p className='text:lg!'><b className="font:medium">Syntax highlighting</b></p>
        ...
        <Feature>
            ...
            <div>
                <p className='text:lg!'><b className="font:medium">Syntax inspection</b></p>
        ...
        <Feature>
            ...
            <div>
                <p className='text:lg!'><b className="font:medium">Code completion</b></p>
        ...
        <Feature>
            ...
            <div>
                <p className='text:lg!'><b className="font:medium">Color preview</b></p>
