...
| App structure and hierarchy | Preset roles | `bg:canvas`, `surface:base`, `b:base`, `text:body` |
...
## Preset color roles
Preset roles describe the job a color performs in the interface. Their values are mode-aware, so `bg:canvas`, `surface:base`, `b:base`, and `text:body` can stay stable while light and dark modes choose different underlying colors.

### Canvas
Canvas is the root page or app background role. Use it with the regular background color shorthand.
