...
<main class="bg:surface-base text:body">
    <section class="surface:raised b:1px|solid|base">
...
```html
<!-- @MARK bg:surface-base --><!-- @MARK surface:raised -->
<main class="bg:surface-base">
    <section class="surface:raised"></section>
</main>
```
...
@theme dark {
    --color-surface-base: $color-gray-95;
