...
<Code lang="js" name="master.css.js">{require('./tests/add-a-color/master.css.js?raw').default}</Code>
Apply it using color-related syntax and even change the opacity.
<Code lang="html">{require('./tests/add-a-color/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-a-color/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/add-a-color-with-opacity/master.css.js?raw').default}</Code>
Apply it using color-related syntax like [`fg:`](/reference/color).
<Code lang="html">{require('./tests/add-a-color-with-opacity/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-a-color-with-opacity/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/add-an-alias/master.css.js?raw').default}</Code>
Apply it using color-related syntax.
<Code lang="html">{require('./tests/add-an-alias/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-an-alias/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/add-an-alias-with-opacity/master.css.js?raw').default}</Code>
Apply it using color-related syntax like [`fg:`](/reference/color).
<Code lang="html">{require('./tests/add-an-alias-with-opacity/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-an-alias-with-opacity/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/add-colors-by-theme/master.css.js?raw').default}</Code>
Using modes for variables, you can access a single source of truth and simplify the markup.
<Code lang="html">{require('./tests/add-colors-by-theme/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-colors-by-theme/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/override-default-colors/master.css.js?raw').default}</Code>
Apply custom colors for the current application.
<Code lang="html">{require('./tests/override-default-colors/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/override-default-colors/generated.css?raw').default}</Code>
    </div>
</details>
