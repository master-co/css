...
<svg viewBox="0 0 320 190" class="block w:100%" role="img" aria-label="Warm plaster walls, an arched doorway and a sunlit courtyard">
...
<svg viewBox="0 0 320 190" class="block w:100%" role="img" aria-label="Olive and moss leaves growing in a pale sage garden">
...
<svg viewBox="0 0 320 190" class="block w:100%" role="img" aria-label="A terracotta ceramic vessel against a petrol backdrop with a copper shelf">
