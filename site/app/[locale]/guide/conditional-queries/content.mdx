...
You can [create a condition variant](/guide/theme#condition-variants) to simplify longer conditions.
...
```
Create a [condition variant](/guide/theme#condition-variants) if the same media query appears repeatedly.
...
```
Create a [condition variant](/guide/theme#condition-variants) if the same support check appears repeatedly.
...
Create a [condition variant](/guide/theme#condition-variants) if a longer container query appears repeatedly.
