...
Any shorthand not listed in `config.atTokens` will be implicitly treated as a `@container`, falling back to the default behavior of being eligible for container queries.
