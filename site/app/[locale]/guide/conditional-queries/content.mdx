...
You can [create an at token](/guide/at-tokens) to simplify longer conditions.
...
```
Create an [at token](/guide/at-tokens) if the same media query appears repeatedly.
...
```
Create an [at token](/guide/at-tokens) if the same support check appears repeatedly.
...
Create an [at token](/guide/at-tokens) if a longer container query appears repeatedly.
