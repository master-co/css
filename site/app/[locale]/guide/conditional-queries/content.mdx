...
You can [create a token](/guide/at) to simpify the class name.
...
Any shorthand not listed in `config.atRuleAliases` will be implicitly treated as a `@container`, falling back to the default behavior of being eligible for container queries.
