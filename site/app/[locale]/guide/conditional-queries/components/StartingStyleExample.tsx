...
export default () => <>
    <Demo>
        ...
        <div id="my-popover" popover="auto" className="transition:transform|slow|smooth b:px|solid|line p:xl r:xl bg:surface max-w:90vw bg:black/.3::backdrop transform:scale(0)@starting-style">
