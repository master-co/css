...
export default () => <>
    <Demo>
        ...
        <div id="my-popover" popover="auto" className="max-w:90vw p:xl b:1px|solid|line r:xl bg:surface transition:transform|slow|smooth bg:black/.3::backdrop transform:scale(0)@starting-style">
