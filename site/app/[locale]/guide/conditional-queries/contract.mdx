...
You can [create a condition variant](/guide/directives#custom-variant) to simplify longer conditions.
...
```
Create a [condition variant](/guide/directives#custom-variant) if the same media query appears repeatedly.
...
```
Create a [condition variant](/guide/directives#custom-variant) if the same support check appears repeatedly.
...
Create a [condition variant](/guide/directives#custom-variant) if a longer container query appears repeatedly.
