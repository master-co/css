...
| 13 | Planned: choose the next benchmark publication or product-level runtime strategy; no interaction-cost refresh is required from Phase 12 because no runtime change landed. |
