...
The primary charts compare Master CSS and Tailwind CSS using CLI output so the headline view stays focused on static artifact output. Vite setup data remains available in the expanded detail tables.
