...
A curated internal snapshot is generated from the all-scenario `browser-lifecycle` baseline. It remains internal even though segmented five-minute long-session evidence has passed across Master static, runtime, progressive, and Tailwind static browser-control modes, because public conclusions still need repeated review and presentation. The current data should be used for benchmark validation rather than public performance claims.
