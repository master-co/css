...
<figure>
    <BrowserLifecycleSummary />
    <figcaption>Coverage and correctness checks for the internal browser lifecycle evidence.</figcaption>
</figure>
...
<figure>
    <BrowserLifecycleLongSessionCharts />
    <figcaption>Committed five-minute long-session medians for browser rendering and runtime work.</figcaption>
</figure>

<figure>
    <BrowserLifecycleLongSessionTable />
    <figcaption>Complete committed five-minute long-session evidence for every mode.</figcaption>
</figure>
