...
(i) Spacing variables should be defined in [`spacing`](/guide/variables#add-a-spacing-variable) section.
...
const preference = localStorage.getItem(key) || defaultPreference;
