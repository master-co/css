...
Conceptual request waterfall for the CDN runtime script and default manifest. Bar positions show relative discovery and reuse timing, not measured network data.
<ResourceWaterfall />
