...
Elevation needs a visible ground. Pair shadows with `bg:canvas`, `surface:*`, `text:*`, and radius tokens so depth reads correctly in light and dark themes.

<SurfaceElevationDemo />

```html
<!-- @MARK bg:canvas --><!-- @MARK text:body --><!-- @MARK surface:base --><!-- @MARK surface:raised --><!-- @MARK surface:overlay --><!-- @MARK shadow:sm --><!-- @MARK shadow:lg -->
<main class="bg:canvas text:body">
    <section class="surface:base r:lg">
        ...
        <aside class="surface:overlay r:lg shadow:lg">
            Detached overlay
        </aside>
    </section>
</main>
