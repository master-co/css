...
<Code lang="js" name="master.css.js">{require('./tests/add-a-media-query/master.css.js?raw').default}</Code>
When displayed in landscape orientation, the image is presented in a 2:1 aspect ratio.
<Code lang="html">{require('./tests/add-a-media-query/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-a-media-query/generated.css?raw').default}</Code>
    </div>
</details>
...
<Code lang="js" name="master.css.js">{require('./tests/add-a-feature-query/master.css.js?raw').default}</Code>
Applies translucent background only when `backdrop-filter` is supported.
<Code lang="html">{require('./tests/add-a-feature-query/template.html?raw').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/add-a-feature-query/generated.css?raw').default}</Code>
    </div>
</details>
