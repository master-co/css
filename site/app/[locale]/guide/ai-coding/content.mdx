...
Use [Reusing styles](/guide/reusing-styles) for abstraction decisions and [Code linting](/guide/code-linting) for the class policy that keeps AI-generated markup reviewable.
