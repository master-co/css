...
| `mastercss_scan_project` | Scan source files, register stylesheet entries, and report scanner state and generated CSS metadata. |
| `mastercss_lint_project` | Run Master CSS class-list diagnostics and return fix proposals without writing files. |
