...
For token authoring, see [Theme Tokens](/guide/theme). For mode behavior, see [Variables and Modes](/guide/variables-and-modes). For custom variant strategy, see [Conditional Queries](/guide/conditional-queries).
