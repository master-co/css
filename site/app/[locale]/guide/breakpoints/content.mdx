...
Use [comparison](/reference/rules/conditions#comparison-operators) and [logical](/reference/rules/conditions#logical-operators) operators when a style belongs to a range instead of every larger viewport.
...
<main class="w:full mx:auto px:md max-w:4xl@sm max-w:5xl@md px:xl@md max-w:7xl@lg">
  ...
</main>
```
