...
When runtime code needs project tokens, modes, or component definitions, load the compiled config object from the integration. `virtual:master-css-config` resolves the canonical project-level config discovered from the CSS entry.
