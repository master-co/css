...
Those native rules can also pull matching config variables referenced by `var(--*)` and configured keyframes referenced by animation declarations. Add `@preserve native;` when native CSS must be preserved.
