import PageCSSSizeBenchmark from '../introduction/components/PageCSSSizeBenchmark'
...
| --- | --- | --- | --- |
| CSS entry graph | Project stylesheets with `@master entry;` or `@import '@master/css'` | Compiler, integrations, static renderer | Authoring source for tokens, settings, variants, managed styles, source directives, and native CSS roots. |
