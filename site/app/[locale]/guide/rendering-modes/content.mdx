...
The extractor does not observe the DOM and does not execute application code. Its input is source text, CSS entries, extraction options, and the compiled [theme configuration](/guide/theme). Its output is a CSS asset that the browser loads like any other stylesheet.
