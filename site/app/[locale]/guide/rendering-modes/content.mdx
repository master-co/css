...
<StepSection>
    <Step>
        ...
        The integration creates a source scanner with source directives, optional fixed classes, and the project CSS entry graph. During development, integrations use their host watch, HMR, or invalidation system to reset or update this context.
