...
<Demo $py={0}>
    <DemoPanel className="flex flex-col gap:xl w:full">
        <div className="w:full">
            ...
            <DemoP className="font:5xl font:regular leading:1 text-pretty">Designing for consistency across every platform.</DemoP>
        </div>
        <div className="w:full">
            <DemoLabel className="text:green">text:5xl</DemoLabel>
            <DemoP className="text:5xl font:regular text-pretty">Designing for consistency across every platform.</DemoP>
        </div>
    </DemoPanel>
</Demo>
