...
The typography system is built on a set of [theme tokens](/guide/theme#define-theme-tokens) that are organized into namespaces. This allows for easy customization and consistent application across your design.
