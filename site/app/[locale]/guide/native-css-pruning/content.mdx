...
## Plan references
Pruned native CSS can reference variables and keyframes from the project CSS entry graph. When a kept native rule uses `var(--*)` or a plan animation name, Master CSS includes the required plan output.
