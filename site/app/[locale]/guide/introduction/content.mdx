...
Assuming the card can be reused, define it as a main style using [components](/guide/components) in the project CSS entry:
```css name=index.css
@master;
@master {
    .card {
