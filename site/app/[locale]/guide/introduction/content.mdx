...
Assuming the card has become reusable, define it as a [component class](/guide/reusing-styles#components) in the project CSS entry:
...
5. [Design tokens](/guide/design-tokens), [theme](/guide/theme), and [component classes](/guide/reusing-styles#components) when your project needs shared vocabulary.
