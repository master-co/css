...
4. [Theme Tokens](/guide/theme) when you need shared values, [Variables and Modes](/guide/variables-and-modes) when those values need modes, and [Global Styles](/guide/global-styles) when repeated roles become components or utilities.
