...
```html
<!-- @MARK fg:blue-60 --><!-- @MARK :hover --><!-- @MARK @sm -->
<h1 class="fg:blue-60 fg:red-60:hover font:3xl font:5xl@sm font:heavy m:2xl text-center">
    Hello World
</h1>
```

<Demo $py={0}>
    <h1 className="fg:blue-60 fg:red-60:hover font:3xl font:5xl@sm font:heavy m:2xl text-center">Hello World</h1>
</Demo>

<details>
    <summary>Generated CSS</summary>
    <Class2CSS>
        {'fg:blue-60 fg:red-60:hover font:3xl font:5xl@sm font:heavy m:2xl text-center'}
    </Class2CSS>
</details>
