...
export const code3 = `
    <div class="flex translateY(-5):hover ~transform|fast|smooth overflow:hidden bg:white r:xl">
...
<Demo>
    <div className="mx:auto max-w:120x">
        <div className="flex translateY(-5):hover ~transform|fast|smooth overflow:hidden bg:surface r:xl s:panel justify-center items-center">
