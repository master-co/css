...
Container variables belong in the theme layer and use the `--container-*` namespace.
...
Container query variants use the same `--container-*` variables as sizing utilities.
