...
For token namespace behavior, see [Variables and Modes](/guide/variables-and-modes). For creating tokens, see [Theme Tokens](/guide/theme). For directive syntax, see [CSS directives](/guide/directives). For abstraction decisions, see [Global Styles](/guide/global-styles#shared-vocabulary).
