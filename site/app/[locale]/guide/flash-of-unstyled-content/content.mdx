import FOUCSvg from '~/site/public/fouc.svg'
...
<figure>
  <FOUCSvg className="h:auto aspect-ratio:16/9 surface:raised" />
...
The initialization is typically completed within milliseconds, and you don't need to worry about the impact of `hidden` as it's instantaneous.
