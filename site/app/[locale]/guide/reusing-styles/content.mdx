...
```html
<button class="px:action-x r:lg bg:brand text:white">
    Submit
</button>
```
...
<Demo>
    <button className="justify-center items-center inline-flex bg:black text:white font:sm font:medium h:10x px:md r:lg outline:2px|solid|blue:focus outline-offset:0.125rem:focus">Submit</button>
</Demo>
