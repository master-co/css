...
```css name=index.css
@theme {
    --color-accent-line: $color-black/.1;
    --color-accent-hover: $color-blue-60;
...
```html
<button class="px:control-x r:control bg:accent fg:accent-text">
    Submit
</button>
```
...
Component definitions are plan inputs, not immediate CSS output. Defining `.btn` does not generate CSS until `btn` appears in scanned classes or is composed by another CSS-defined style.
...
<Demo>
    <button className="justify-center items-center inline-flex bg:surface-inverse fg:inverse font:sm font:medium h:10x px:md r:lg outline:2|focus:focus outline-offset:2:focus">Submit</button>
</Demo>
...
<Demo className="gap:xl">
    <button className="btn btn-xs accent touch-accent">Submit</button>
    <button className="btn btn-sm accent touch-accent">Submit</button>
    <button className="btn btn-md accent touch-accent">Submit</button>
    <button className="btn btn-lg accent touch-accent">Submit</button>
    <button className="btn btn-xl accent touch-accent">Submit</button>
</Demo>
...
<Demo>
    <button className="btn btn-md rounded accent touch-accent">Submit</button>
</Demo>
...
Local composed stylesheets share the project CSS entry and plugin-provided plan context, so theme tokens, custom variants, and managed component classes remain available. Local files do not define the global project plan, do not insert generated Master CSS, and do not participate as native CSS pruning roots.
...
@theme dark {
    --color-accent-line: $color-white/.3;
    --color-accent-hover: $color-blue-50;
    --color-accent-text: $color-white;
}

@components {
    accent {
        outline: 0.0625rem var(--color-accent-line) solid;
...
```html
<!-- @MARK accent touch-accent -->
<button class="btn btn-md accent touch-accent">Submit</button>
```
