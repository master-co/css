...
- `@layer components`, `@layer defaults`, and `@layer utilities` create on-demand managed class definitions.
...
## Rules and summary
### Component rules
- Put component definitions in top-level `@layer components`; use `@layer defaults` only when a definition intentionally belongs to the earlier defaults layer.
