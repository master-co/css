...
```html
<button class="inline-flex align-items:center justify-content:center gap:xs px:md py:xs r:lg font:sm font:medium bg:primary fg:white">
    Save changes
</button>
```
...
```html
<button class="pi:control-x r:control bg:yellow fg:on-yellow">
    Submit
</button>
```
...
<Demo>
    <button className="justify-center items-center inline-flex bg:surface-inverse fg:inverse font:sm font:medium h:10x pi:md r:lg outline:2px|solid|focus:focus outline-offset:0.125rem:focus">Submit</button>
</Demo>
