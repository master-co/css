...
```html
<button class="inline-flex align-items:center justify-content:center gap:xs px:md py:xs r:lg font:sm font:medium bg:primary text:white">
    Save changes
</button>
```
...
```css name=index.css
@theme {
    --color-yellow: $color-yellow-40;
    --color-on-yellow: $color-yellow-95;
    --color-yellow-line: $color-black/.1;
...
```html
<button class="pi:control-x r:control bg:yellow text:on-yellow">
    Submit
</button>
```
...
<Demo>
    <button className="justify-center items-center inline-flex bg:surface-inverse text:inverse font:sm font:medium h:10x pi:md r:lg outline:2px|solid|focus:focus outline-offset:0.125rem:focus">Submit</button>
</Demo>
...
@components {
    ...
    btn-xs {
        @compose r:sm pi:xs font:xs h:6x;
    }

    btn-sm {
        @compose r:md pi:sm font:xs h:8x;
    }

    btn-md {
        @compose r:md pi:md font:sm h:10x;
    }

    btn-lg {
        @compose r:lg pi:lg font:md h:12x;
    }

    btn-xl {
        @compose r:xl pi:lg font:md h:14x;
    }
}
```
...
.button {
    @compose inline-flex align-items:center justify-content:center gap:xs pi:md h:10x r:lg;
    background: var(--color-primary);
    color: white;
}
...
@theme light {
    --color-yellow: $color-yellow-40;
    --color-yellow-hover: $color-yellow-50;
    --color-on-yellow: $color-yellow-95;
    --color-yellow-line: $color-black/.1;
}

@theme dark {
    --color-yellow: $color-yellow-50;
    --color-yellow-hover: $color-yellow-40;
    --color-on-yellow: $color-yellow-95;
    --color-yellow-line: $color-white/.3;
}

@components {
    yellow {
        outline: 0.0625rem var(--color-yellow-line) solid;
