...
<Demo>
    <button className="justify-center items-center inline-flex bg:surface-inverse fg:inverse font:sm font:medium h:10x pi:md r:lg outline:2px|focus:focus outline-offset:2:focus">Submit</button>
</Demo>
