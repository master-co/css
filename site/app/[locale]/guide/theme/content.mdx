...
@theme light {
    --shadow-sm: 0 16px 40px rgb(15 23 42 / .12);
}

@theme dark {
    --shadow-sm: 0 0 0 1px rgb(255 255 255 / .08), 0 16px 40px rgb(0 0 0 / .36);
}
...
```html
<section class="bg:white text:strong p:lg r:lg shadow:sm grid-cols:2@md">
    <button class="bg:blue text:white px:md py:xs r:md bg:blue/.85:interactive">Save</button>
</section>
```
...
<article class="bg:white text:strong p:md r:lg shadow:sm font:sans">
...
```html
<section class="bg:white text:strong shadow:sm">
    <button class="bg:blue text:white">Save</button>
</section>
```
...
<html class="dark">
    <body>
        <div class="bg:white text:strong">...</div>
    </body>
</html>
```
