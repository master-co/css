...
<ExpandContent>
    <Code lang="css" name="animations.css">{require('../../../../../packages/preset/src/animations.css?raw')}</Code>
</ExpandContent>

### `syntax.css`

<ExpandContent>
    <Code lang="css" name="syntax.css">{require('../../../../../packages/preset/src/syntax.css?raw')}</Code>
</ExpandContent>
