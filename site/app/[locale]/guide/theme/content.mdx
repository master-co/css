...
```html
<section class="bg:surface text:strong p:card r:card shadow:card grid-cols:2@md">
    <button class="bg:accent text:on-accent px:md py:xs r:md bg:accent-hover:interactive">Save</button>
</section>
```
...
<article class="bg:surface text:strong p:card r:card shadow:card font:sans">
    <h2 class="font:sans">Dashboard</h2>
    <a class="text:link" href="/settings">Settings</a>
</article>
```
...
```html
<section class="bg:surface text:strong">
...
<html class="dark">
    <body>
        <div class="bg:surface text:strong">...</div>
    </body>
</html>
```
...
<article class="font:semibold_:headings">
    <button class="text:link:interactive">Save</button>
