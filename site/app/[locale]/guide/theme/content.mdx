...
The default entry imports focused public files. Use `@master/css/theme.css` for theme tokens and managed keyframes, and `@master/css/syntax.css` for syntax tokens when you need a smaller entry.
