...
<div class="transform:scale(1.1):hover transition:transform|.2s">
    ...
    <div class="abs animation:flash|3s|infinite mix-blend-mode:overlay height:fit inset:0 m:auto">
        <h1 class="fg:white font:7vw font:40px@xs font:heavy text-center">
            Hello, World!
        </h1>
    </div>
</div>
...
<Demo>
    <div className="fg:#175fe9 font:56px font:heavy">Aa</div>
</Demo>
```html
<!-- @MARK fg:#175fe9 -->
...
<Demo>
    <div className="fg:rgb(23,95,233) font:56px font:heavy">Aa</div>
</Demo>
```html
