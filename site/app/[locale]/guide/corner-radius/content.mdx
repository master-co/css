...
The corner radius system is defined in the `variables.border-radius` namespace. This namespace includes a set of utility [theme tokens](/guide/theme#theme-tokens) that can be used to apply corner radius styles to elements.
