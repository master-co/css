...
import { RadiusNamespaceTable } from './components/RadiusNamespace'
...
Promote repeated raw values into the radius scale. Keep one-off measured geometry as raw values such as `r:1px` or `r:0.5rem` until it becomes a reusable shape.
