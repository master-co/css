...
- **Components** — rules from abstract components defined in `@master components` or `config.components`.
- **Utilities** — rules from common utilities (e.g., `mcss flex`, `mcss @fade|1s`).
...
You can select descendants with `@preset` to preset styles, preventing component and utility styles from being overwritten.
...
If styles conflict, the order of priority: **Utilities** > **Components** > **Theme** > **Preset** > **Base**.
