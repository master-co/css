...
<ConfiguredExample source={'@layer components { .btn { @compose inline-flex bg-blue-60 fg-white; } }'} classes={['btn']} element="button" label="Preview button" />
...
<ConfiguredExample source={'@layer components { .btn { @compose inline-flex bg-blue-60 fg-white; } }'} classes={['btn', 'flex']} element="button" label="Preview button" />
