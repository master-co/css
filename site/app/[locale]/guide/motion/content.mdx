...
<Demo>
    <div className="container w:full">
        <div className="grid grid-cols:1 gap:md w:full grid-cols:2@container(3xs)">
            <div className="p:lg r:lg surface:raised shadow:xs">
                <DemoLabel>animation:fade|slow|smooth</DemoLabel>
                <div className="size:14x r:lg bg:blue-5 animation:fade|slow|smooth|infinite|alternate@motion"></div>
            </div>
            <div className="p:lg r:lg surface:raised shadow:xs">
                <DemoLabel>animation:zoom|fast|overshoot</DemoLabel>
                <div className="size:14x r:lg bg:green-5 animation:zoom|fast|overshoot|infinite|alternate@motion"></div>
            </div>
        </div>
    </div>
</Demo>
...
<div class="translate:0@reduce-motion animation:none@reduce-motion animation:zoom|fast|overshoot@motion"></div>
```
