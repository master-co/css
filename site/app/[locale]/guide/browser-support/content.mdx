...
Master CSS will parse the applied selector string according to the syntax structure and insert it into the corresponding CSS rule, you can enter any string after `:` or `::`.
