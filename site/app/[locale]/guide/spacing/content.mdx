...
The `x` suffix multiplies the configured [base unit](/guide/theme#project-settings), which defaults to **4 pixels**. Use it for measured geometry that should stay aligned with the spacing grid but does not need a named token.
