...
```css name=index.css
@master {
    --spacing-sm: 12; /* [!code highlight] */
    --spacing-md: 16; /* [!code highlight] */
    --spacing-lg: 24; /* [!code highlight] */
}
```
...
The spacing system is grounded on a consistent and scalable design token foundation. It uses a [base unit](/guide/theme#tune-project-scales) of **4 pixels**, which acts as the smallest scalable measurement across your interface.
<XScale />
