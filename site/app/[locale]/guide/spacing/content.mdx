...
The spacing system is grounded on a consistent and scalable design token foundation. It uses a [base unit](/guide/theme#project-settings) of **4 pixels**, which acts as the smallest scalable measurement across your interface.
<XScale />
