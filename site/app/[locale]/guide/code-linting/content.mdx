...
(!) <span className="text:warning">"m:0.625rem" applies the same CSS declarations as "m:5x".</span><br/><span className="text:warning">"m:5x" applies the same CSS declarations as "m:0.625rem".</span>
```html
...
(!) <span className="text:warning">"m:10x@sm" applies the same CSS declarations as "m:3.125rem@sm".</span><br/><span className="text:warning">"m:3.125rem@sm" applies the same CSS declarations as "m:10x@sm".</span>
```html
