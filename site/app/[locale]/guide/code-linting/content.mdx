...
<Image className="aspect:2/1 r:lg max-w:container-3xl w:full" src={require('~/site/public/consistent-class-order.webp').default} alt="Consistent class order" unoptimized />
...
<Image className="aspect:2/1 r:lg max-w:container-3xl w:full" src={require('~/site/public/disallow-unknown-class.webp').default} alt="Disallow unknown classes" unoptimized />
...
<Image className="aspect:2/1 r:lg max-w:container-3xl w:full" src={require('~/site/public/class-collision-detection.webp').default} alt="Class collision detection" unoptimized />
...
<Image className="aspect:2/1 r:lg max-w:container-3xl w:full" src={require('~/site/public/supports-js-utilities.webp').default} alt="Supports JS utilities" unoptimized />
