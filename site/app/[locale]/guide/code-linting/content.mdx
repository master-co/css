...
You can also restrict teams to using [theme](/guide/theme) and [components](/guide/components) instead of defining classes through traditional `html <style>` or CSS files.
