...
| `@master/css/prefer-canonical-classes` | `warn` | Yes | Prefer semantic utilities, theme tokens, property aliases, and composition utilities. |
...
```html
<div class="font:xs font:2xl@sm m:xl block font:3xl@md mb:2xl">...</div> <!-- [!code --] -->
<div class="block font:xs font:2xl@sm font:3xl@md m:xl mb:2xl">...</div> <!-- [!code ++] -->
```

Sorting also removes duplicate class values in the same class string.

```html
<button class="inline-flex px:md inline-flex">...</button> <!-- [!code --] -->
<button class="inline-flex px:md">...</button> <!-- [!code ++] -->
```
...
```html
<h1 class="text-align:center font:16px margin:md">...</h1> <!-- [!code --] -->
<h1 class="text-center font:md m:md">...</h1> <!-- [!code ++] -->
```

It also canonicalizes multi-value tokens and direct CSS variable references when every value maps to the active theme:

```html
<div class="m:1rem|1.5rem fg:var(--color-red-60)">...</div> <!-- [!code --] -->
<div class="m:md|lg fg:red-60">...</div> <!-- [!code ++] -->
```

Related size and spacing pairs can be composed into shorter utilities:

```html
<div class="w:md h:md mt:md mb:md padding-left:1rem padding-right:1rem">...</div> <!-- [!code --] -->
<div class="size:md my:md px:md">...</div> <!-- [!code ++] -->
```
...
```html
<div class="m:0.625rem m:5x">...</div> <!-- [!code --] -->
<div class="m:5x">...</div> <!-- [!code ++] -->
```
...
Partially overlapping spacing shorthands are split so the surviving declarations are kept:

```html
<div class="mx:md ml:lg">...</div> <!-- [!code --] -->
<div class="mr:md ml:lg">...</div> <!-- [!code ++] -->
```
