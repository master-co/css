...
Use [ASP.NET Core static rendering](/guide/installation/aspnet-core) when Razor class strings are complete at build time and you want a generated CSS asset.
