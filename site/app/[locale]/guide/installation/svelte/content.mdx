...
<StepSection>
    ...
    <Step $row>
        ...
        <StepR>
            ...
            <script lang="ts">
                import { onMount, type ComponentType } from "svelte"; /* [!code ++] */
                import { Fragment } from "@master/css.svelte"; /* [!code ++] */
                import type { CSSRuntimeProvider as CSSProviderType } from "@master/css.svelte"; /* [!code ++] */
                …

                let CSSRuntimeProvider: ComponentType<CSSProviderType> = Fragment as any; /* [!code ++] */

                onMount(async () => { /* [!code ++] */
                    CSSRuntimeProvider = (await import("@master/css.svelte")).default; /* [!code ++] */
                }); /* [!code ++] */
            </script>
        ...
        <StepR>
            ...
            export async function handle({ event, resolve }) {
                return await resolve(event, {
                    transformPageChunk: ({ html }) => render(html, config).html /* [!code ++] */
                })
            }
            ```
        </StepR>
