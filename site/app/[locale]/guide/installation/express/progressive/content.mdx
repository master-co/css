...
Progressive rendering sends the first response with `style#master-css`, then the runtime adopts the injected hydration manifest and keeps handling classes added after the initial response. Use [Express static rendering](/guide/installation/express) when templates contain complete class strings and you want a generated CSS asset instead.
