...
<StepSection>
  ...
  <Step $row>
    ...
    <StepR>
      ```bash name=Terminal
      npm install express ejs @master/css@rc @master/css-runtime@rc @master/css-server@rc @master/css-preset@rc
  ...
  <Step $row>
    ...
    <StepR>
      ...
      <body>
        ...
        const rendered = renderer.renderHTML(document, {
      ...
      server.on('close', () => renderer.dispose())
      ```
    </StepR>
  </Step>
  <Step $row>
