...
Use [Next.js runtime rendering](/guide/installation/nextjs/runtime-rendering) when CSS should be generated only in the browser. Use [Next.js static rendering](/guide/installation/nextjs/static-rendering) when classes are statically visible and you need build-time CSS output.
