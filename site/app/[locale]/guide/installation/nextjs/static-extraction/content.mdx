...
<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            (i) Static extraction reads your `master.css` config and scans source files. `@master` definitions are not emitted directly; only classes discovered in source generate CSS.
        </StepL>
        <StepR>
    ...
    <Step>
        ...
        export default function Home() {
            return (
                <h1 className="italic m:2xl fg:strong font:5xl font:heavy">Hello World</h1>
            )
        }
        ```
