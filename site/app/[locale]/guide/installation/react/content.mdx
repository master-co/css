<StepSection>
    ...
    <Step $row>
        ...
        <StepR>
            ```bash action=install
            -D @master/eslint-config-css@rc @eslint/compat eslint-plugin-react eslint-plugin-react-hooks eslint-plugin-react-refresh globals typescript-eslint eslint
            ```
