<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            Run the installer in runtime mode from the Webpack project root. It registers the Webpack plugin and creates the Master CSS entry stylesheet.
        </StepL>
        <StepR>
            ```bash name=Terminal
...
export default {
    plugins: [
        new MasterCSSPlugin({ mode: 'runtime' })
    ]
}
```
