<StepSection>
    ...
    <Step $row>
        ...
        <StepR>
            ```bash action=install
            @master/css@rc @master/css-preset@rc @master/css-runtime@rc
            ```
        </StepR>
    </Step>
    <Step $row>
        <StepL>
            ...
            Create a new file `npm_packages/src/index.js` and initialize the runtime engine. This manual setup uses the bundled preset plan; use an official build integration when application code needs to import the compiled project plan.
        </StepL>
        <StepR>
            ```js name=npm_packages/src/index.js
            …
            import defaultPlan from '@master/css-preset/default-plan.json' with { type: 'json' }; // [!code highlight]
            import { initCSSRuntime } from '@master/css-runtime'; // [!code highlight]

            initCSSRuntime({ plan: defaultPlan }) // [!code highlight]
            ```
        </StepR>
    </Step>
    <Step $row>
        <StepL>
            ### <StepNum />Link the default stylesheet
                ...
                {[
                    {
                        ...
                        code: `
                            <html>
                                <head>
                                    <link rel="stylesheet" href="https://cdn.master.co/css@rc/base.css"> <!-- [!code highlight] -->
                                </head>
                            </html>
                        `
                    }
                        ...
                        code: `
                            {
                                ...
                                scripts: {
                                    ...
                                    "build": "webpack ./src/index.js --output-path ../wwwroot/js --output-filename index.bundle.js --mode=development" // [!code highlight]
                                }
                            }
                        `
                    }
                ...
                {[
                    {
                        ...
                        code: `
                            <Project>
                                ...
                                <Target Name="PreBuild" BeforeTargets="PreBuildEvent"> <!-- [!code highlight] -->
                                    <Exec Command="npm install" WorkingDirectory="npm_packages" /> <!-- [!code highlight] -->
                                    <Exec Command="npm run build" WorkingDirectory="npm_packages" /> <!-- [!code highlight] -->
                        ...
                        code: `
                            <html>
                                ...
                                <body>
                                    ...
                                    <script src="js/index.bundle.js"></script> <!-- [!code highlight] -->
                                </body>
                            </html>
                        `
                    }
            ...
            {[
                {
                    ...
                    code: `
                        ...
                        <h1 class="italic m:2xl text:strong font:5xl font:heavy"> <!-- [!code highlight] -->
