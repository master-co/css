<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            Create a new file `npm_packages/src/index.js` and import the `master.css` config to enable the runtime engine.
        </StepL>
        <StepR>
            ```js name=npm_packages/src/index.js
            …
            import { initCSSRuntime } from '@master/css-runtime'; // [!code highlight]
            import config from 'master.css'; // [!code highlight]

            initCSSRuntime(config) // [!code highlight]
            ```
        </StepR>
    </Step>
    <Step $row>
                ...
                {[
                    {
                        ...
                        code: `
                            <html>
                                <head>
                                    <link rel="stylesheet" href="https://cdn.master.co/css@rc/normal.css"> <!-- [!code highlight] -->
                                </head>
                            </html>
                        `
                    }
