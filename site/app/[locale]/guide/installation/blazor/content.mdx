<StepSection>
    ...
    <Step $row>
        ...
        <StepR>
            ...
            …
            import defaultManifest from '@master/css-preset/default-manifest.json' with { type: 'json' }; // [!code highlight]
            import { CSSRuntime } from '@master/css-runtime'; // [!code highlight]

            CSSRuntime.create({ manifest: defaultManifest }).observe() // [!code highlight]
            ```
        </StepR>
    </Step>
    <Step $row>
            ...
            {[
                {
                    ...
                    code: `
                        ...
                        <h1 class="italic m:2xl text:neutral font:5xl font:heavy"> <!-- [!code highlight] -->
