...
.pricing-card {
  @compose p-lg b:1px|solid|var(--color-line-base) r-xl surface-raised;
}
```
...
.home-cta {
  @compose inline-flex items-center justify-center gap-xs h:3rem px-lg r-xl bg-blue fg-white;
...
```css name=app/home/home.css
.home-cta {
  @compose transition:transform|var(--duration-normal)|var(--easing-standard);
...
- Move repeated values into [Theme Tokens](/guide/theme).
