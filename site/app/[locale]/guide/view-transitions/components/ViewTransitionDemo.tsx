        ...
        <Demo className="container w:full">
            ...
            <div className="grid grid-cols:1 grid-cols:2@container(4xs) gap:lg w:full">
                    ...
                    {views.map((view) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="block fg:neutral mt:2xs text:xs">{view.eyebrow}</span>
                            </button>
                        )
                    })}
                </div>
                <section className={clsx(
                    ...
                    <p className="text:xs font:medium fg:neutral m:0">{active.eyebrow}</p>
                    ...
                    <p className="fg:neutral text:sm m:0 mt:md max-w:full">
                        {active.body}
                    </p>
                </section>
            </div>
