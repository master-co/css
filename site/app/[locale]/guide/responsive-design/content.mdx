...
<ResizeZone width="100%" originX="center" showRuler>
    <Demo>
        <div className="container w:full surface:raised b:1px|solid|base r:lg overflow:hidden">
            <div className="flex flex-col@container(<=2xs)">
                <Image src="/images/blur.png" className="object-cover aspect-ratio:3/2 w:64x {w:full;aspect-ratio:16/9}@container(<=2xs)" width={300} height={200} alt="container left" />
                <div className='p:lg|xl'>
                    <div className='text:md text:neutral font:medium'>Lorem ipsum</div>
