...
<ResizeZone width="100%" originX="center" showRuler>
  <Demo>
    <div className="overflow:hidden container w:full b:1px|solid|base r:lg surface:raised">
      <div className="flex flex-col@container(<=2xs)">
        <Image src="/images/blur.png" className="w:3xs aspect-ratio:3/2 object-cover {w:full;aspect-ratio:16/9}@container(<=2xs)" width={300} height={200} alt="container left" />
