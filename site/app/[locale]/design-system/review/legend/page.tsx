...
function BorderSpecimens() {
  return <div className="review-legend-specimens">
    <div className={`review-legend-specimen b:2px|solid|var(--color-blue) surface-raised`}>Subject</div>
    <div className={`review-legend-specimen b:2px|solid|var(--color-violet) surface-raised`}>Comparison</div>
  </div>
}
...
const options = [
  {
    ...
    preview: <OriginalDemo><div className="review-legend-originalContent"><div className="review-legend-originalItems">
      <div><OriginalDemoLabel>Subject border</OriginalDemoLabel><div className={`review-legend-specimen b:2px|solid|var(--color-blue) surface-raised`}>Subject</div></div>
      <div><OriginalDemoLabel>Comparison border</OriginalDemoLabel><div className={`review-legend-specimen b:2px|solid|var(--color-violet) surface-raised`}>Comparison</div></div>
