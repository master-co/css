...
function PreviousSource() {
  return <p className="review-source-previousSource">
...
export default function Page() {
  return <main className="review-source-review">
    ...
    <p className="review-source-intro">A chart’s provenance should be easy to find without taking over the measured result. This optional source line complements the Guide’s complete data-source table.</p>
    <div className="review-source-reviewNote" role="note">Adopted shared style: <code>BenchmarkSource</code> now uses the refined evidence footer. The published Guide keeps its complete source table.</div>
    ...
    <section aria-labelledby="source-options">
      ...
      <p className="review-source-sectionCopy">Each version points to the same committed benchmark snapshot. The date comes from its actual JSON metadata.</p>
    ...
    <section aria-labelledby="source-real-use">
      ...
      <div className="review-source-realUse"><OriginalSourceRow /></div>
