...
<Demo $py={0}>
    <DemoPanel>
        <div className="b:16|solid|transparent border-image:linear-gradient(45deg,dodgerblue,hotpink)|30 p:10x r:8 bg:white bg:gray-95@dark">
            <div className="fg:strong font:18 font-weight:560">Gradient border image</div>
            <p className="fg:muted font:14 my:4x">The image is sliced and painted into the border area.</p>
        </div>
    </DemoPanel>
</Demo>
```html
