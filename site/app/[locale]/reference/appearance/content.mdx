...
<label class="grid gap-sm w:240px max-w:100%">
  ...
  <span class="rel block">
    ...
    class="w:100% pr-xl b:1px|solid|var(--color-line-base) r-sm
...
<label class="grid gap-sm w:240px max-w:100%">
  Sort assets
  <span class="rel block">
    <select id="target" class="w:100% appearance:auto">
      <option value="newest">Newest first</option>
      <option value="oldest">Oldest first</option>
      <option value="name">Name</option>
    </select>
...
<label class="grid gap-sm w:240px max-w:100%">
  ...
  <span class="rel block">
    ...
    class="w:100% appearance:none appearance:auto@print
...
<label class="grid gap-sm w:240px max-w:100%">
  ...
  <span class="rel block">
    <select id="target"
      class="w:100% appearance:auto appearance:none:focus">
      <option value="newest">Newest first</option>
      <option value="oldest">Oldest first</option>
      <option value="name">Name</option>
    </select>
