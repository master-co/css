...
<Demo>
    <div className="bg:stripe-pink">
        <div className="box w:180px aspect-ratio:1/1 inset:20px rel">`inset:20px`</div>
    </div>
</Demo>
```html
<!-- @MARK inset:20px -->
<div>
    <div class="rel inset:20px">inset:20</div>
</div>
```
...
```html
<div class="inset:10:hover inset:20px@sm inset:0@print">...</div>
```
