...
<a class="text:underline text-decoration-thickness:2px">
    Strong underline
</a>
```
...
<a class="text:underline text-decoration:from-font">
    Typeface underline
</a>
```
...
```html
<a class="text:underline text-decoration-thickness:2px text-underline-offset:4px">
    Balanced underline
</a>
```
