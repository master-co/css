...
Static grammar highlighting is intentionally configuration-independent. It can recognize stable Master CSS syntax such as declarations, values, selectors, queries, groups, functions, and punctuation, but it cannot know whether a token such as `brand`, `btn`, or `surface` comes from your project configuration.
