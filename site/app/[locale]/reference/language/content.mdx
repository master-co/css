...
```
The transformer decorates Shiki spans with classes such as `mcss-semantic-class`, `mcss-semantic-class-declaration`, `mcss-semantic-property`, `mcss-semantic-variable`, `mcss-semantic-type`, and `mcss-semantic-modifier`.
