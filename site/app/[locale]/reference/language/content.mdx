...
<details>
    ...
    <div>
        <Code lang="ts">{require('!!raw-loader!~/packages/language/src/grammars.ts').default}</Code>
    </div>
</details>
...
<details>
    ...
    <div>
        <Code lang="ts">{require('!!raw-loader!~/packages/language/src/declaration.ts').default}</Code>
    </div>
</details>
