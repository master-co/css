...
Semantic tokens are generated with the configured Master CSS engine, so custom variables, components, utilities, modes, and other plan-dependent tokens can be classified after the project plan is loaded by the caller.
