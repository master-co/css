...
```html
<!-- @MARK shape-outside:circle(50%) -->
<img class="float:left shape-outside:circle(50%) shape-margin:1rem" src="/images/avatar.jpg" alt="Avatar">
```
...
```html
<!-- @MARK shape-none -->
<img class="float:left shape-outside:circle(50%) shape-none@print" src="/images/avatar.jpg" alt="Avatar">
```
...
```html
<img class="shape-outside:circle(50%):hover shape-outside:inset(0|20px)@sm shape-none@print" src="/images/avatar.jpg" alt="">
```
