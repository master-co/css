...
<div class="rel px-lg pb-lg pt-xl b:1px|solid|var(--color-line-base) r-sm">
  <label class="flex items-center gap-sm">
    <input type="checkbox"> Snap to grid
  </label>
  <div id="target" aria-hidden="true"
    class="abs inset:0 b:1px|dashed|var(--color-violet) r-sm
           untouchable">
...
```html
<div class="p-md b:1px|dashed|var(--color-violet) r-sm untouchable">
