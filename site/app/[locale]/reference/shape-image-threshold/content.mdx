...
<img class="float:left shape:url(/mask.png) shape-image-threshold:.5" src="/images/photo.jpg" alt="Photo">
```
...
This property only matters for shapes that use an image source, such as `shape:url(*)` or gradient-based shapes.
```html
<img class="float:left shape:url(/mask.png) shape-image-threshold:.5" src="/images/photo.jpg" alt="">
```
