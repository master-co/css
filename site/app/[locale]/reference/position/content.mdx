...
<Demo>
    <div className="box align-items:initial! justify-content:initial! p:8|20_li p:10|0! r:10 w:full max-w:340@sm max-h:250 overflow:auto">
            ...
            {users.map((user, index) =>
                <li className="bg:gray-28:hover bg:gray-32:active flex gap:12 cursor:pointer" key={index}>
                    ...
                    <div>
                        ...
                        <p className="text:13 m:0 text:left">{user.message}</p>
                    </div>
                </li>
            )}
        </ul>
