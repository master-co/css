...
<button class="transition-property:transform transition-duration:180ms transition-timing-function:ease-out transform:translateY(-2px):hover">
    Hover
</button>
```
...
<div class="transition-property:opacity transition-duration:1s transition-timing-function:linear">
    Syncing
</div>
```
