...
<Demo $py={0}>
    <DemoPanel className="flex flex-col gap:8x w:full">
        <div className="w:full">
            ...
            <DemoP className="text:pretty text:4xl font:regular">Designing for clarity and consistency across every platform.</DemoP>
        </div>
        <div className="w:full">
            <DemoLabel>text:3xl</DemoLabel>
            <DemoP className="text:pretty text:3xl font:regular">Designing for clarity and consistency across every platform.</DemoP>
        </div>
    </DemoPanel>
</Demo>
```html
