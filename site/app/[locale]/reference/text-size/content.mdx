...
## Examples
### Basic usage
Use the predefined text size tokens like `text:sm`, `text:md`, and `text:lg` to set the font size and line height of an element.
<Demo $py={0}>
...
```
If you don’t want to include line height, use the [`font:<size>`](/reference/font-size) syntax.
