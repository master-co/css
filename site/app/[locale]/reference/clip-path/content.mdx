...
<div class="size:160px outline:1px|solid|var(--color-line-muted)
         bg-surface-base">
...
<div
  class="h:120px w:240px max-w:100%
         outline:1px|solid|var(--color-line-muted) bg-surface-base">
  <div id="target"
    class="grid place-items:center h:120px w:240px
           max-w:100% b:2px|solid|var(--color-blue-60) font-md
