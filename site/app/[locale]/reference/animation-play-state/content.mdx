...
<div class="animation-name:rotate animation-duration:1s animation-iteration-count:infinite animation-play-state:running">
    Running
</div>
```
...
<button class="animation-name:rotate animation-duration:1s animation-iteration-count:infinite animation-play-state:paused:hover">
    Pause on hover
</button>
```
