...
<Demo $py={0}>
    <DemoPanel>
        <div className="grid-rows:3 gap:2x h:180px">
            <div className="min-w:0 p:3x r:8px bg:blue-5 bg:blue-95@dark border:1px|solid|blue-20 border-color:blue-80@dark">1</div>
            <div className="min-w:0 p:3x r:8px bg:gray-5 bg:gray-90@dark">2</div>
            <div className="min-w:0 p:3x r:8px bg:gray-5 bg:gray-90@dark">3</div>
        </div>
    </DemoPanel>
</Demo>
```html
