...
<img class="float:left shape-outside:circle(50%) shape-margin:2rem" src="/images/photo.jpg" alt="Photo">
```
...
```html
<img class="float:left shape-outside:circle(50%) shape-margin:1rem" src="/images/avatar.jpg" alt="">
```
