...
<Demo class="py:0">
    <input type="text" className="p:0.313rem|0.625rem caret-color:pink-70 transition:caret-color|.3s outline:none bg:surface b:2px|solid|gray-83 b:2px|solid|pink-70:focus r:8px" />
</Demo>
```html
