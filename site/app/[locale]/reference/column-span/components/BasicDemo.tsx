        ...
        <Demo $py={0}>
            <DemoPanel>
                <div className="columns:3 gap:8x">
                    ...
                    <p className={clsx(className, 'text:strong font:bold')}>No matter what type of animal you are interested in, you will find something interesting and informative here.</p>
