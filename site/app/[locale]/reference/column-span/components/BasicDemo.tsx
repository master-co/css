...
export default ({ className }: any) => {
    return (
        <Demo $py={0}>
            <DemoPanel>
                <div className="columns:3 gap:8x">
                    <p className="m:0">There are many different types of animals, each with unique characteristics.</p>
                    <p className={clsx(className, 'text:neutral font:bold')}>No matter what type of animal you are interested in, you will find something interesting and informative here.</p>
