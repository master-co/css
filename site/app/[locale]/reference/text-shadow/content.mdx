...
```html
<!-- @MARK text-shadow:0|1|2|black/.2 -->
<h1 class="text-shadow:0|1|2|black/.2">
    Readable heading
</h1>
```
...
```html
<!-- @MARK fg:white --><!-- @MARK text-shadow:0|1|3|black/.45 -->
<h2 class="fg:white text-shadow:0|1|3|black/.45">
    Mountain retreat
</h2>
```
...
```html
<div class="text-shadow:none text-shadow:0|1|2|black/.2@sm text-shadow:none@print">...</div>
```
