...
<span class="box-decoration-break:slice bg:primary/.12">
    Wrapped inline text
</span>
```
...
<span class="box-decoration-break:clone bg:primary/.12 pi:1x">
    Wrapped inline text
</span>
```
...
```html
<span class="box-decoration-break:clone bg:accent-surface">
