...
```html
<!-- @MARK bg:url(/hero.jpg) --><!-- @MARK bg:blue/.4 --><!-- @MARK background-blend-mode:multiply -->
<section class="bg:url(/hero.jpg) bg:blue/.4 background-blend-mode:multiply">
    ...
</section>
```
...
<details>
    ...
    <Class2CSS>
        {['bg:url(/hero.jpg)', 'bg:blue/.4', 'background-blend-mode:multiply']}
    </Class2CSS>
</details>
