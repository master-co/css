...
```html
<div id="layout" class="flow-root w:70x max-w:full" role="group" aria-label="Available space">
  <div id="target" class="h:16x w:40x m:md p:sm">External space</div>
</div>
```
...
```html
<div id="layout" class="flow-root w:70x max-w:full" role="group" aria-label="Available space">
  <div id="target" class="h:12x w:40x mb:lg ml:md p:sm">First block</div>
  <div id="peer" class="h:12x w:40x mr:lg mt:sm p:sm">Second block</div>
</div>
```
...
<div id="layout" class="flow-root w:70x max-w:full" role="group" aria-label="Available space">
  <div id="target" class="h:16x w:40x mx:auto my:sm p:sm">Centered</div>
</div>
```

```html
<!-- Vertical logical margins -->
<div id="layout" class="flow-root size:40x writing-mode:vertical-rl" role="group" aria-label="Available space">
  <div id="target" class="h:24x w:16x mx:md my:sm p:sm">Vertical</div>
</div>
```
...
```html
<div id="layout" class="flex gap:sm w:70x max-w:full p:md" role="group" aria-label="Available space">
  <button id="target" type="button" class="px:md py:sm b:0">Cancel</button>
  <button id="peer" type="button" class="px:md py:sm b:0">Save</button>
</div>
```
...
```html
<div id="layout" class="flow-root w:70x max-w:full" role="group" aria-label="Available space">
  <div id="target" class="h:16x w:40x m:0 p:sm m:md@sm">Same box</div>
</div>
```
