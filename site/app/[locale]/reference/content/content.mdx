...
<Demo $py={0}>
    <DemoPanel>
        <p class="margin-block:0">Discover high-quality products at XYZ Corporation. Visit [our website](https://www.example.com) for exclusive deals and unbeatable prices.</p>
    </DemoPanel>
</Demo>
```html
