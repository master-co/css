...
On-demand:
<Code lang="css">
    {require('@master/normal.css/src/index.css?raw').default?.replace(/(..\/)\b/g, '@master/normal.css/')}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-abbreviation-styles.css?raw').default}
</Code>

### Consistent control styles
Fixed the inconsistent appearance of controls across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-control-styles.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-horizontal-lines.css?raw').default}
</Code>

### Consistent bold styles
Fixed the inconsistent font weight of `html <b>` and `html <strong>` across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-bold-styles.css?raw').default}
</Code>

### Consistent code styles
Fixed the inconsistent font size of code-related elements across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-code-styles.css?raw').default}
</Code>

### Consistent small styles
Fixed the inconsistent font size of `html <small>` across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-small-styles.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-superscript-subscript.css?raw').default}
</Code>

### Consistent table styles
Fixed the inconsistent appearance of tables across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-table-styles.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/intuitive-sizing-control.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-anchor-styles.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-control-styles.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-default-borders.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-default-spacing.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/eliminate-click-delays.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/better-text-appearance.css?raw').default}
</Code>

### Readable tab size
Setting the tab size to 4 makes the code more structured and easier to read.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/readable-tab-size.css?raw').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/responsive-media-elements.css?raw').default}
</Code>
