...
`*` is for raw-any full-value wrappers, such as paired vendor declarations. It may be used alone or with namespace refs, as in `text-decoration:<~color-text|~color|*>`, but it cannot be mixed with enum values or raw kinds.
