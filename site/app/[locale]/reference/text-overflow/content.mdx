...
<span class="w:40x overflow:hidden white-space:nowrap text:ellipsis">
...
<div class="flex gap:sm">
    ...
    <span class="min-w:0 overflow:hidden white-space:nowrap text:ellipsis">
        quarterly-roadmap-final-version.pdf
    </span>
</div>
```
...
```html
<div class="text:clip text:ellipsis@sm text:clip@print">...</div>
```
