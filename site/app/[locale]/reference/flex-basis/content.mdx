...
Use `flex-basis:container-*` when flex item sizing should align with the shared container scale.
```html
<!-- @MARK flex-basis:container-md -->
<aside class="flex-basis:container-md flex-shrink:0">...</aside>
```
