...
export default async function Page() {
    return (
        <main className="min-h:100dvh p:md bg:white">
            <section className="grid-cols:4 gap:sm w:full max-w:3xl mx:auto grid-cols:8@2xs">
                <header className="flex flex-col grid-col-span:4 items-start justify-between gap:sm p:sm b:1px|solid|gray-20 r:lg bg:white shadow:xs flex-row@4xs items-center@4xs grid-col-span:8@2xs">
                    <div className="min-w:0">
                        <div className="font:semibold text:neutral">Workspace layout</div>
                        <div className="mt:2xs text:sm text:gray">Responsive product surface</div>
                    </div>
                    <div className="flex items-center gap:xs">
                        <button className="grid place-content:center size:8x b:1px|solid|gray-20 r:md bg:white text:gray" aria-label="Search">
                            <IconSearch className="size:4x stroke:1.75" />
                        </button>
                        <button className="grid place-content:center size:8x b:1px|solid|gray-20 r:md bg:white text:gray" aria-label="Notifications">
                            <IconBell className="size:4x stroke:1.75" />
                        </button>
                    </div>
                </header>

                <nav className="flex overflow:auto grid-col-span:4 gap:xs p:xs b:1px|solid|gray-20 r:lg bg:white shadow:xs grid-col-span:8@2xs">
                    {tabs.map((tab, index) => (
                        <a
                            key={tab}
                            className={
                                index === 0
                                    ...
                                    : 'px:sm py:xs r:md font:medium font:sm text-decoration:none white-space:nowrap text:gray'
                            }
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|gray-20 r:lg bg:white shadow:xs grid-col-span:2@4xs grid-col-span:4@2xs">
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|gray-20 r:lg bg:white shadow:xs grid-col-span:5@2xs">
                    <div className="flex items-center justify-between gap:md">
                        <div>
                            <div className="font:semibold text:neutral">Weekly demand</div>
                            <div className="mt:2xs text:sm text:gray">Traffic and conversion trend</div>
                        </div>
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|gray-20 r:lg bg:white shadow:xs grid-col-span:3@2xs">
                    <div className="flex items-center justify-between gap:md">
                        <div>
                            <div className="font:semibold text:neutral">Launch tasks</div>
                            <div className="mt:2xs text:sm text:gray">3 open items</div>
                        </div>
