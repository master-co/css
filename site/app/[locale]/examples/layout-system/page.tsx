    ...
    return (
        <main className="min-h:100dvh p:md bg:canvas">
            <section className="grid-cols:4 gap:sm w:full max-w:3xl mx:auto grid-cols:8@2xs">
                <header className="flex flex-col grid-col-span:4 items-start justify-between gap:sm p:sm b:1px|solid|line r:lg bg:surface shadow:xs flex-row@4xs items-center@4xs grid-col-span:8@2xs">
                    ...
                    <div className="flex items-center gap:xs">
                        <button className="grid place-content:center size:8x b:1px|solid|line r:md bg:surface text:muted" aria-label="Search">
                            <IconSearch className="size:4x stroke:1.75" />
                        </button>
                        <button className="grid place-content:center size:8x b:1px|solid|line r:md bg:surface text:muted" aria-label="Notifications">
                            <IconBell className="size:4x stroke:1.75" />
                        </button>
                    </div>
                </header>

                <nav className="flex overflow:auto grid-col-span:4 gap:xs p:xs b:1px|solid|line r:lg bg:surface shadow:xs grid-col-span:8@2xs">
                    {tabs.map((tab, index) => (
                        <a
                            key={tab}
                            className={
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|line r:lg bg:surface shadow:xs grid-col-span:2@4xs grid-col-span:4@2xs">
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|line r:lg bg:surface shadow:xs grid-col-span:5@2xs">
                ...
                <article className="grid-col-span:4 p:sm b:1px|solid|line r:lg bg:surface shadow:xs grid-col-span:3@2xs">
                    <div className="flex items-center justify-between gap:md">
                        <div>
