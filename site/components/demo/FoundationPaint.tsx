...
export function FoundationColorRoles() {
  return <DemoThemeComparison name="color-roles" title="One composition, two modes" html={`<article class="p:md r:lg b:1px|solid|base surface:raised text:body">
...
<article class="p:md r:sm b:1px|solid|base surface:raised">
...
<section class="p:md r:sm b:1px|solid|base surface:raised"><h2 class="m:0 text:md font:medium">Default boundary</h2><p class="mt:xs mb:0 text:muted">b:1px|solid|base</p></section>
<section class="p:md r:sm b:1px|solid|strong surface:raised"><h2 class="m:0 text:md font:medium">Emphasized boundary</h2><p class="mt:xs mb:0 text:muted">b:1px|solid|strong</p></section>
...
export function FoundationTextRoles() {
  return <DemoThemeComparison name="text-roles" title="Readable hierarchy" html={`<article class="grid gap:sm p:md r:lg b:1px|solid|base surface:raised text:body">
...
<span class="w:fit px:sm py:2xs r:sm surface:inverse text:inverse">Private note</span>
...
<div class="h:16x r:sm bg:yellow" aria-label="Yellow background swatch" role="img"></div>
<p class="m:0 font:mono font:xs text:muted">bg:yellow</p>
<svg class="size:12x fg:yellow" viewBox="0 0 48 48" role="img" aria-label="Yellow diamond"><path d="M24 2 46 24 24 46 2 24Z" fill="currentColor"/></svg>
...
export function FoundationTextHue() {
  return <DemoThemeComparison name="text-hue" title="Foreground color by role" html={`<article class="p:md r:sm b:1px|solid|base surface:raised">
