...
export function FoundationTypography() {
  return <Specimen name="type-hierarchy" title="A readable type hierarchy" scene={{ html: `<article class="p:md r:sm b:1px|solid|base surface:raised text:body">
...
<section><p class="mb:sm text:sm font:medium">Fade · 300ms</p><div data-ui="surface"><div id="fade" class="p:md r:sm surface:raised b:1px|solid|base animation:fade|slow|smooth@screen&motion"><strong class="text:strong">Collection saved</strong><p class="mt:xs mb:0 text:muted">A quiet opacity entrance.</p></div></div><p class="mt:xs mb:0" data-ui="label"><output data-animation-readout="fade">Paused</output></p></section>
<section><p class="mb:sm text:sm font:medium">Zoom · 150ms</p><div data-ui="surface"><div id="zoom" class="p:md r:sm surface:raised b:1px|solid|base animation:zoom|fast|overshoot@screen&motion"><strong class="text:strong">New collection</strong><p class="mt:xs mb:0 text:muted">A brief scale entrance.</p></div></div><p class="mt:xs mb:0" data-ui="label"><output data-animation-readout="zoom">Paused</output></p></section>
...
<span aria-hidden="true" class="block h:64px mt:md p:xs outline:1px|dashed|muted"><span id="layer" class="grid place-items:center h:48px w:128px b:1px|solid|blue-60 r:sm font:sm bg:blue-10 fg:blue-80 transform:none transition:transform|slow|overshoot|150ms@screen&motion">Layer 01</span></span>
...
}`, html: `<article class="p:md r:sm b:1px|solid|base surface:raised"><h2 class="m:0 text:lg font:semibold">Collection settings</h2><p class="mt:xs mb:md text:muted">Open a native dialog to preview its entrance.</p><button id="open" type="button">Open details</button></article>
<dialog id="details" aria-labelledby="dialog-title" aria-describedby="dialog-description" class="w:calc(100%-32px) max-w:xs m:auto p:md r:lg b:1px|solid|base surface:overlay text:body shadow:xl animate:dialog-in@screen&motion">
