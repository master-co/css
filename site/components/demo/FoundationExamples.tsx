    ...
    <DemoContainer title="Media object">
      <div className="container">
        <article className="flex flex-col items-start gap:md p:md flex-row@container(md) demo-surface">
          <DemoMedia className="w:full aspect-ratio:4/3 r:sm fg:demo-blue flex-shrink:0@container(md) w:36x@container(md)" aria-label="Blue mountain illustration" />
    ...
    <DemoContainer title="Container grid">
      <section className="container">
        <article className="grid-cols:1 gap:lg p:md grid-cols:2@container(md) demo-surface">
          <DemoMedia className="w:full aspect-ratio:3/2 r:sm fg:demo-blue" aria-label="Blue mountain illustration" />
...
export function FoundationSizing() {
  return <Demo title="Fluid space, measured object" data-foundation="sizing">
    <DemoSurface className="w:full max-w:sm mx:auto p:md">
      <DemoLabel>w:full · max-w:sm</DemoLabel>
      <div className="flex items-center gap:md mt:md">
        <DemoItem className="grid flex-shrink:0 place-content:center size:12x round text:sm font:mono">FN</DemoItem>
        <div className="flex:1 min-w:0">
...
export function FoundationAxes() {
  return <Demo title="Choose one axis or both" data-foundation="axes">
    <div className="flex items-end gap:md">
      <div className="flex-shrink:0"><DemoLabel>size:14x</DemoLabel><DemoItem className="grid place-content:center size:14x mt:sm font:mono">FN</DemoItem></div>
      <div className="flex:1 min-w:0"><DemoLabel>w:full h:14x</DemoLabel><DemoItem tone="violet" className="grid place-content:center h:14x w:full mt:sm text:sm">Collection</DemoItem></div>
    </div>
  </Demo>
}
...
export function FoundationShrink() {
  return <Demo title="Keep long content within its cap" padding="none" data-foundation="shrink" caption="The row stops at sm. The flexible text region can shrink below its content width.">
    <DemoContainer title="Shrinkable row">
      <article className="flex gap:md w:full max-w:sm mx:auto p:md demo-surface">
        <DemoItem className="grid flex-shrink:0 place-content:center size:10x text:sm font:mono">FN</DemoItem>
        <div className="flex:1 min-w:0">
...
export function FoundationRadius() {
  return <Demo title="One scale, related surfaces" data-foundation="radius">
    <DemoComparison className="grid-cols:3 gap:sm">
      <div><DemoLabel>r:sm</DemoLabel><DemoItem className="grid place-content:center h:20x mt:sm r:sm text:sm">Control</DemoItem></div>
      <div><DemoLabel>r:lg</DemoLabel><DemoItem className="grid place-content:center h:20x mt:sm r:lg text:sm">Panel</DemoItem></div>
      <div><DemoLabel>r:2xl</DemoLabel><DemoItem className="grid place-content:center h:20x mt:sm r:2xl text:sm">Feature</DemoItem></div>
    </DemoComparison>
  </Demo>
}
...
export function FoundationShapes() {
  return <Demo title="Content-sized pill and width-led circle" data-foundation="shapes" caption="These links share a destination. Their shape is independent of their native navigation behavior.">
    <div className="flex flex-wrap items-end gap:lg">
      <div><DemoLabel>rounded</DemoLabel><div className="mt:sm"><a href="#use-shape-shortcuts" className="inline-flex items-center justify-center min-h:44px px:md py:sm rounded b:1px|solid|base text:sm text-decoration:none bg:demo-surface text:body">Shape shortcuts</a></div></div>
      <div><DemoLabel>w:48px round</DemoLabel><div className="mt:sm"><a href="#use-shape-shortcuts" aria-label="Shape shortcuts" className="inline-flex items-center justify-center w:48px round b:1px|solid|base bg:demo-surface text:blue"><IconArrowUp size={20} aria-hidden="true" /></a></div></div>
    </div>
  </Demo>
}
