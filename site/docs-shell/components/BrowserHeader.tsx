...
const BrowserHeader = ({ url }: any) => {
  return (
    <div className="flex w:full p:xs|sm rtl:5px rtr:5px backdrop-filter:blur(1px) contain:content {rtl:0px;rtr:0px;mt:0;bt:0px}+.demo">
      <div className="w:25%">
        <WindowControls />
      </div>
      <div className="flex items-center justify-center w:50% font:xs">
        ...
        <span className="line-clamp:1 leading:1 text:muted">{url}</span>
      </div>
