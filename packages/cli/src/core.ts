...
export default async function runProgram(argv: string[] = process.argv) {
  ...
  program
    ...
    .addOption(new Option('--from <profile>', 'Saved RC language profile.').choices(['rc-legacy', 'rc-named', 'rc-native', 'rc-managed', 'rc-utilities']).makeOptionMandatory())
  ...
  program
    ...
    .option('--strict', 'Fail CSS syntax or value validation before publishing any generated assets.')
