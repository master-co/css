...
- Prefer existing @theme tokens and native CSS in @layer defaults or @layer components. Use @utilities for on-demand primitives and @compose only for shared utility behavior; ordinary CSS classes cannot be composed.
