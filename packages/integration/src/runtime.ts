...
export const CSS_RUNTIME_INJECTION = [
    ...
    `const initCSSRuntime = masterCSSRuntime.initCSSRuntimeAsync || masterCSSRuntime.initCSSRuntime;`,
    `void initCSSRuntime({ manifest: masterCSSManifest, emittedGlobals: masterCSSEmittedGlobals });`,
    `}`,
].join('\n')
