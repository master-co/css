import type { MasterCSSToolingBindingSession } from './tooling-binding-contract'
...
export function protectToolingSession<T extends MasterCSSToolingBindingSession>(
  session: T
): T {
