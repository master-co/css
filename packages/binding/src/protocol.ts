...
export const MASTER_CSS_BINDING_ABI_VERSION = 9 as const
...
export const MASTER_CSS_VALIDATOR_BATCH_VERSION = 2 as const
export const MASTER_CSS_DIAGNOSTICS_REPORT_VERSION = 2 as const
export const MASTER_CSS_LINT_BATCH_VERSION = 1 as const
export const MASTER_CSS_LANGUAGE_BATCH_VERSION = 3 as const
