...
export const MASTER_CSS_BINDING_ABI_VERSION = 12 as const
export const MASTER_CSS_LANGUAGE_VERSION = 3 as const
...
export const MASTER_CSS_VALIDATOR_BATCH_VERSION = 3 as const
export const MASTER_CSS_DIAGNOSTICS_REPORT_VERSION = 3 as const
export const MASTER_CSS_LINT_BATCH_VERSION = 1 as const
export const MASTER_CSS_LANGUAGE_BATCH_VERSION = 4 as const
export const MASTER_CSS_LEXER_BATCH_VERSION = 1 as const
export const MASTER_CSS_SOURCE_BATCH_VERSION = 2 as const
...
export type MasterCSSErrorCode =
  ...
  | 'invalid-compose-layer'
  | 'removed-managed-directive'
  ...
  | 'SOURCE_PARSE_ERROR'
  | 'UNKNOWN_CONDITION'
  | 'MASTER_QUERY_REQUIRES_CSS'
  | 'UNDEFINED_MODE'
  | 'UTILITY_NAME_CONFLICT'
  | 'AMBIGUOUS_TOKEN'
  | 'UNKNOWN_TOKEN'
  | 'INTERNAL'
