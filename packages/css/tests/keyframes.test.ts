...
it('expects the keyframe output', () => {
    ...
    expect(render(['@shake|1s'])).toContain('@keyframes shake{0%{transform:none}6.5%{transform:translate(-6px) rotateY(-9deg)}18.5%{transform:translate(5px) rotateY(7deg)}31.5%{transform:translate(-3px) rotateY(-5deg)}43.5%{transform:translate(2px) rotateY(3deg)}50%{transform:none}}')
