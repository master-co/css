test('group', () => {
    expect(new MasterCSS().create('{color:indigo!;bb:2|solid}')?.text).toBe('.\\{color\\:indigo\\!\\;bb\\:2\\|solid\\}{color:rgb(90 91 213)!important;border-bottom:0.125rem solid}')
    ...
    expect(new MasterCSS({ important: true }).create('{color:indigo!;bb:2|solid}')?.text).toBe('.\\{color\\:indigo\\!\\;bb\\:2\\|solid\\}{color:rgb(90 91 213)!important;border-bottom:0.125rem solid!important}')
