test('color', () => {
    ...
    expect(new MasterCSS().create('foreground:current')?.text).toContain('color:currentColor')
    expect(new MasterCSS().create('fg:transparent')?.text).toContain('color:transparent')
    expect(new MasterCSS().create('foreground:transparent')?.text).toContain('color:transparent')
    expect(new MasterCSS().create('fg:inherit')?.text).toContain('color:inherit')
    expect(new MasterCSS().create('foreground:var(--color)')?.text).toContain('color:var(--color)')
})
