...
test('core grammar leaves predefined static values to semantic tokens', () => {
    ...
    assertNoTokenScope(flexDirection, 'flex-col', 'support.constant.property-value.css')
    assertNoTokenScope(flexDirection, 'flex-row-reverse', 'support.constant.property-value.css')
...
test('core grammar aligns strings and selector separators with CSS-like scopes', () => {
    ...
    assertNoTokenScope(selector, 'block', 'support.constant.property-value.css')
    assertNoTokenScope(selector, 'state-name', 'entity.other.attribute-name.pseudo-class.css')
    assertNoTokenScope(selector, 'hidden', 'support.constant.property-value.css')
...
test('HTML injection stops at the class attribute quote after selector suffixes', () => {
    ...
    assertNoTokenScope(tokens, 'hidden', 'support.constant.property-value.css')
...
test('CSS injection highlights top-level component directives and compose classes', () => {
    ...
    assertNoTokenScope(tokens, 'inline-flex', 'support.constant.property-value.css')
    assertTokenScope(tokens, 'fg', 'support.type.property-name.css')
    assertTokenScope(tokens, 'hover', 'entity.other.attribute-name.pseudo-class.css')
