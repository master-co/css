...
- `packages/compiler` owns the CSS configuration directives such as `@theme` and `@master`; breaking or expanding that syntax usually requires matching grammar updates here.
