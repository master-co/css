...
- `packages/compiler` owns the CSS configuration directives such as `@theme`, `@master`, `@custom-at`, and `@custom-selector`; breaking or expanding that syntax usually requires matching grammar updates here.
