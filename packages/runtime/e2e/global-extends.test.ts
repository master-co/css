...
test('extends', async ({ page }) => {
    ...
    expect(await page.evaluate(() => globalThis.cssRuntime.variables.primary)).toBeDefined()
    expect(await page.evaluate(() => globalThis.cssRuntime.variables.secondary)).toBeDefined()
