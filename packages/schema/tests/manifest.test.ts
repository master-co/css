...
describe('@master/css-schema manifest helpers', () => {
  ...
  it('normalizes derived manifest fields in JSON', () => {
    ...
    expect(serializeMasterCSSManifest(manifest)).toBe(
      '{"version":1,"languageVersion":3,"variables":{"color":[{"key":"brand","value":"#123"}]},"utilities":[{"id":"block","type":-2,"emit":{"type":"static","rules":[{"declarations":{"display":"block"}}]},"matchers":[{"type":"static","name":"block"}]}]}'
    )
  })
})
