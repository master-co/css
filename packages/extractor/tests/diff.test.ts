...
describe('extractLatentClasses contract fixtures', () => {
    const fixtures: [string, string, string[]][] = [
        ...
        ['html basic', '<div class="bg:white fg:black m:8 p:8">x</div>', ['bg:white', 'fg:black', 'm:8', 'p:8']],
        ...
        ['width-height shorthand', '<div class="min:40|80 calc(100vw-60)x20rem">x</div>', ['min:40|80', 'calc(100vw-60)x20rem']],
