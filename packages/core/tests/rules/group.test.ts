...
test.concurrent('group', () => {
    expect(createCSS().create('{color:black!;bb:2|solid}')?.text).toBe('.\\{color\\:black\\!\\;bb\\:2\\|solid\\}{color:rgb(0 0 0)!important;border-bottom:0.125rem solid}')
    expect(createCSS({ important: true }).create('{color:black!;bb:2|solid}')?.text).toBe('.\\{color\\:black\\!\\;bb\\:2\\|solid\\}{color:rgb(0 0 0)!important;border-bottom:0.125rem solid!important}')
