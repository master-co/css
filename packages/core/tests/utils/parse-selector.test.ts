...
export const cases = {
    ...
    'design token': [
        ...
        ['_:headings', ' :is(h1,h2,h3)', [
            ...
            { variants: [{ token: ':headings', branches: [{ selector: '&:is(h1,h2,h3)' }] }] }
        ],
        [':combo', ':is(h1,h2)+div', [
            {
                children: [
            ...
            { variants: [{ token: ':combo', branches: [{ selector: '&:is(h1,h2)+div' }] }] }
        ],
        ...
        // ],
        //     {
        //         variants: [{ token: '::both', branches: [{ selector: '&::before,&::after' }] }],
        //         utilities: [
