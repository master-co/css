...
new Tester({
    ...
    5: 'btn btn@sm card block font:12 bg:red:hover block@sm box-content@base text:center@default',
    6: 'btn btn@sm card block {text:center} font:12 m:1x>ul>li {font:bold;font:32}>ul>li bg:red:hover block@sm box-content@base text:center@default',
