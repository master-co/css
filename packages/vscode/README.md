...
For project-aware tokens, create a CSS entry that contains `@master;` or `@import "@master/css";`, or declare a Master CSS package dependency in the project `package.json`.
