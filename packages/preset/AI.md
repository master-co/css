...
- Output: `defaultPlan`, `index.css`, `base.css`, `theme.css`, `animations.css`, and `syntax.css`.

## Boundaries

- Keep default token, utility, animation, syntax-variant, and layer-statement source here.
