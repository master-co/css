...
describe('@master/css-preset defaultManifest', () => {
    ...
    it('removes fixed keyword value aliases while preserving raw ambiguous matches', () => {
        ...
        expect(css.createRule('bl:line')?.text).toBe('.bl\\:line{border-left-color:var(--color-line)}')
        expect(css.createRule('bx:1px')?.text).toBe('.bx\\:1px{border-inline-width:1px}')
        expect(css.createRule('by:line')?.text).toBe('.by\\:line{border-block-color:var(--color-line)}')
        expect(css.createRule('b:1px|solid|line')?.text).toBe('.b\\:1px\\|solid\\|line{border:1px solid var(--color-line)}')
        expect(css.createRule('bt:1px|solid|line')?.text).toBe('.bt\\:1px\\|solid\\|line{border-top:1px solid var(--color-line)}')
        expect(css.createRule('b:1px|line')?.text).toBe('.b\\:1px\\|line{border:1px var(--color-line)}')
