...
describe('@master/css-preset defaultManifest', () => {
    ...
    it('removes fixed keyword value aliases while preserving raw ambiguous matches', () => {
        ...
        expect(css.createRule('text-decoration-thickness:px')).toBeUndefined()
        ...
        expect(css.createRule('size:5x|6x')).toBeUndefined()
        expect(css.createRule('min:5x|6x')).toBeUndefined()
        expect(css.createRule('max:5x|6x')).toBeUndefined()
        expect(css.createRule('size:auto')).toBeUndefined()
        expect(css.createRule('size:min')).toBeUndefined()
        expect(css.createRule('size:max')).toBeUndefined()
