...
Do not put compiled matcher indexes, caches, or runtime-only acceleration data into `MasterCSSPlan` unless the browser payload impact is explicitly justified and measured.
