...
describe.concurrent('migrated issue regressions', () => {
    ...
    test('issue #332: logical borders and logical corner radii', () => {
        ...
        const cases = [
            ...
            ['border-inline-start:1px|solid', 'border-inline-start:'],
            ['border-inline-end:1px|solid', 'border-inline-end:'],
            ['border-block-start:1px|solid', 'border-block-start:'],
            ['border-block-end:1px|solid', 'border-block-end:'],
            ['border-inline:1px|solid', 'border-inline:'],
            ['border-block:1px|solid', 'border-block:'],
            ...
            ['border-end-end-radius:8', 'border-end-end-radius:8']
        ] as const
