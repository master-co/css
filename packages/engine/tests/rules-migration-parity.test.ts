...
const migratedRuleExpectations = [
    ...
    },
    {
        ...
        cases: [
            ...
            ["border:solid|px", "border:solid 1px"],
        ]
    },
    {
        ...
        cases: [
            ...
            ["border-bottom-width:px", "border-bottom-width:1px"],
            ["border-top-width:px", "border-top-width:1px"],
            ["border-left-width:px", "border-left-width:1px"],
            ["border-right-width:px", "border-right-width:1px"],
    ...
    },
    {
        ...
        cases: [
            ...
            ["border-top:px|solid", "border-top:1px solid"],
            ["bb:px|solid", "border-bottom:1px solid"],
            ["border-bottom:px|solid", "border-bottom:1px solid"],
            ["bl:px|solid", "border-left:1px solid"],
            ["border-left:px|solid", "border-left:1px solid"],
            ["br:px|solid", "border-right:1px solid"],
            ["border-right:px|solid", "border-right:1px solid"],
        ]
    },
    {
    ...
    },
    {
        ...
        cases: [
            ["mbs:4x", "margin-block-start:1rem"],
            ["mbe:4x", "margin-block-end:1rem"],
            ["margin-block:4x", "margin-block:1rem"],
            ["pbs:4x", "padding-block-start:1rem"],
            ["pbe:4x", "padding-block-end:1rem"],
            ["padding-block:4x", "padding-block:1rem"],
            ["iis:4x", "inset-inline-start:1rem"],
            ["iie:4x", "inset-inline-end:1rem"],
            ["ii:4x", "inset-inline:1rem"],
            ["ibs:4x", "inset-block-start:1rem"],
            ["ibe:4x", "inset-block-end:1rem"],
            ["ib:4x", "inset-block:1rem"],
    ...
    },
    {
        ...
        cases: [
            ...
            ["m:4x", "margin:1rem"],
            ["m:px", "margin:1px"],
            ["mis:4x", "margin-inline-start:1rem"],
            ["mie:4x", "margin-inline-end:1rem"],
            ["mi:4x", "margin-inline:1rem"],
        ]
    },
    {
        ...
        cases: [
            ...
            ["outline:$line", "outline-color:var(--color-line)"],
            ["outline:px|solid", "outline:1px solid"],
            ...
            ["outline:auto|px", "outline:auto 1px"],
        ]
    },
    {
    ...
    },
    {
        ...
        cases: [
            ...
            ["p:4x", "padding:1rem"],
            ["pis:4x", "padding-inline-start:1rem"],
            ["pie:4x", "padding-inline-end:1rem"],
            ["pi:4x", "padding-inline:1rem"],
        ]
    },
    {
    ...
    },
    {
        ...
        cases: [
            ["text:1.25rem", "font-size:1.25rem;line-height:max(1.8em - max(0rem, 1.25rem - 1rem) * 1.12, 1.25rem);letter-spacing:clamp(-0.072em, calc((1.25rem - 1rem) * -0.048), 0em)"],
