...
const migratedRuleExpectations = [
    ...
    },
    {
        ...
        cases: [
            ...
            ["bg:line-light", "background-color:var(--color-line-light)"],
    ...
    },
    {
        ...
        cases: [
            ["b:lightest", "border-color:var(--color-line-lightest)"],
            ...
            ["bl:line-lighter", "border-left-color:var(--color-line-lighter)"],
    ...
    },
    {
        ...
        cases: [
            ...
            ["outline:line-neutral", "outline-color:var(--color-line-neutral)"],
            ["outline:$line-neutral", "outline:var(--color-line-neutral)"],
    ...
    },
    {
        ...
        cases: [
            ["w:sm", "width:calc(var(--container-sm) / 16 * 1rem)"],
            ["w:1/4", "width:25%"],
            ["w:3xs", "width:calc(var(--container-3xs) / 16 * 1rem)"],
            ["w:2xs", "width:calc(var(--container-2xs) / 16 * 1rem)"],
            ["w:xs", "width:calc(var(--container-xs) / 16 * 1rem)"],
            ["w:sm", "width:calc(var(--container-sm) / 16 * 1rem)"],
            ["w:md", "width:calc(var(--container-md) / 16 * 1rem)"],
            ["w:lg", "width:calc(var(--container-lg) / 16 * 1rem)"],
            ["w:xl", "width:calc(var(--container-xl) / 16 * 1rem)"],
            ["w:2xl", "width:calc(var(--container-2xl) / 16 * 1rem)"],
            ["w:3xl", "width:calc(var(--container-3xl) / 16 * 1rem)"],
            ["w:4xl", "width:calc(var(--container-4xl) / 16 * 1rem)"],
            ["w:5xl", "width:calc(var(--container-5xl) / 16 * 1rem)"],
            ["w:6xl", "width:calc(var(--container-6xl) / 16 * 1rem)"],
            ["w:7xl", "width:calc(var(--container-7xl) / 16 * 1rem)"],
        ]
    },
    {
