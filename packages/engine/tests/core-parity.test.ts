...
describe.concurrent('default plan utility parity', () => {
    ...
    test('preserves border shorthand matching across value separators', () => {
        ...
        expectClassText(css, 'bl:muted|1px|solid', 'border-left:var(--color-line-muted) 1px solid')
        expectClassText(css, 'border-left:muted|1px|solid', 'border-left:var(--color-line-muted) 1px solid')
        expectClassText(css, 'b:muted|1px|solid', 'border:var(--color-line-muted) 1px solid')
        expectClassText(css, 'bt:muted|1px|solid', 'border-top:var(--color-line-muted) 1px solid')
        expectClassText(css, 'br:muted|1px|solid', 'border-right:var(--color-line-muted) 1px solid')
        expectClassText(css, 'bb:muted|1px|solid', 'border-bottom:var(--color-line-muted) 1px solid')
        expectClassText(css, 'border-inline:muted|1px|solid', 'border-inline:var(--color-line-muted) 1px solid')
        expectClassText(css, 'border-block:muted|1px|solid', 'border-block:var(--color-line-muted) 1px solid')
        expectClassText(css, 'bl:1px|solid|muted', 'border-left:1px solid var(--color-line-muted)')
    })
