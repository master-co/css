...
describe('extractClassCandidates contract fixtures', () => {
  const fixtures: [string, string, string[]][] = [
    ...
    ['html basic', '<div class="bg-white fg-black m:0.5rem p:0.5rem">x</div>', ['bg-white', 'fg-black', 'm:0.5rem', 'p:0.5rem']],
    ...
    ['width-height shorthand', '<div class="min:2.5rem calc(100vw-3.75rem)x20rem">x</div>', ['min:2.5rem', 'calc(100vw-3.75rem)x20rem']],
