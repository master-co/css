...
It does not validate classes, generate CSS, maintain extraction state, watch files, or resolve manifests. Those responsibilities belong to `@master/css-extractor`, `@master/css-engine`, and `@master/css-manifest`.
