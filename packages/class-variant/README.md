...
<p align="center">Create reusable, extensible, and customizable style class variants</p>
...
## Documentation
Check out the official [documentation](https://beta.css.master.co/docs/class-variant).