...
export const stylesheets = z.object({
  entries: z.array(z.object({ filePath: z.string(), masterCSS: z.boolean(), pruneNativeCSS: z.boolean(), dependencies: strings, sourceDependencies: strings, warnings: strings, errors: strings })),
