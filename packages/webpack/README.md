...
<p align="center">Integrate Master CSS in Webpack way</p>
...
## Client types
Add the client type reference when TypeScript source files import `virtual:master-utilities.css`, `virtual:master-css-plan.json`, `virtual:master-css-preloaded`, or `?master-css-plan` modules:
