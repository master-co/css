...
<table>
    ...
    <Documents category='JavaScript API' />
</table>
...
### 🟢 Fonts API
Resolved [#275](https://github.com/master-co/css/issues/275). Check out the latest [documentation](/docs/fonts).
...
```html
<script src="https://cdn.master.co/css@2.0.0-beta.180}"></script>
```
