...
2. **Beta － [{version}](https://github.com/master-co/css/releases)** <svg className="ml:5 inline-block v:middle fill:green-75 size:2x overflow:visible" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg"><circle className="@ping|1s|infinite transform:center" cx="4" cy="4" r="4" /><circle cx="4" cy="4" r="4" /></svg>
...
It's expected to be the **final breaking change** during the rc stage.
...
### 🟢 Master CSS ESLint
Released in [v2.0.0-rc.175](https://github.com/master-co/css/releases/tag/v2.0.0-rc.175). Check out the new [documentation](/docs/code-linting).
...
<details>
    ...
    <div className='b:1|frame p:3x|8x r:1x mt:2x'>
        ...
        Now that we're **at the end of rc**, we can more accurately estimate arrival times based on the task at hand:

        - **Master CSS v2.0**
            - Release Candidate － December 2023
            - Stable － April 2024
        - **Master UI v1.0** － August 2024
...
<details>
    ...
    <div className='b:1|frame p:3x|8x r:1x mt:2x'>
        Only one breaking change remains during the rc, [Color Palette](#-color-palette). If you don't mind or are not affected by it, you can start using Master CSS in production!
    </div>
</details>
<details>
