...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/add-a-color/config.js').default}</Code>
...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/add-a-color-with-opacity/config.js').default}</Code>
...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/add-an-alias/config.js').default}</Code>
...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/add-an-alias-with-opacity/config.js').default}</Code>
Apply it using color-related syntax like [`fg:`](/docs/color).
...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/add-colors-by-theme/config.js').default}</Code>
...
<Code lang="js" name="master.css.js">{require('!!raw-loader!./tests/override-default-colors/config.js').default}</Code>
