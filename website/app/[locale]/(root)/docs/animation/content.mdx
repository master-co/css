...
<Demo $py={0}>
    <div className="app-panel rel">
        ...
        <div className="fg:major abs bottom:0 w:full p:50|35|30|35 gradient(0deg,base|0%,base/0|100%)">
...
<Demo>
    <div className="app-float">
        ...
        <div className="ml:10 font:14 font:medium fg:major">Restoring ...</div>
    </div>
</Demo>
```html
...
<Demo>
    <div className="app-float">
        ...
        <div className="ml:10 font:14 font:medium fg:major">Loading ...</div>
    </div>
</Demo>
```html
