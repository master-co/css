...
<Demo $py={0}>
    <div className="app-panel rel">
        ...
        <div className="fg:strong abs bottom:0 w:full p:50|35|30|35 gradient(0deg,base|0%,base/0|100%)">
            <svg className="inline-block fill:green-75 size:2x overflow:visible" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
...
```html
<svg class="inline-block fill:green-75 size:2x overflow:visible" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
