...
**Master CSS** is a markup-driven CSS language with smart syntax that allows you to construct your user interface using structured and native CSS-like syntax, such as `font:14`, `pt:16`, `w:36@md`, instead of referencing tables or relying on memory.
