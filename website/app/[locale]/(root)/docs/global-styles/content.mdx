...
<Demo $py={0}>
    <DemoPanel className="grid-cols:2 gap:30 gap:50@sm w:full">
        <div>
            <small>Before</small>
...
<Demo $py={0}>
    <DemoPanel className="grid-cols:2 gap:30 gap:50@sm">
        <div>
            <small>Before</small>
