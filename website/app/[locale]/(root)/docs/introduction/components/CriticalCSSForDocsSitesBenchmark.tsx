                    ...
                    .map((result) => {
                        ...
                        return (
                            <Bar key={result.name}>
                                ...
                                <BarShape className={`bg:${brand.color || 'text-lightest'}`} style={{ width: `calc(60% - (${maxTotalCSSSize} - ${result.totalCSSSize}) / ${maxTotalCSSSize} * 60%)` }} />
                                ...
                                {result.name !== 'Master CSS' && <small>{(result?.totalCSSSize / masterCSSResult?.totalCSSSize).toFixed(1)}x larger</small>}
                            </Bar>
                        )
                    })}
            </Bars>
