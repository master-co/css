...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the following commands to quickly start using the [nuxtjs.rr.rc.css.master.co](https://nuxtjs.rr.rc.css.master.co).
...
<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            Run `npx @master/css@rc init` to create a configuration file [master.css.ts](/docs/configuration).
        </StepL>
        <StepR>
            ```bash name=Terminal
