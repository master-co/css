...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the following commands to quickly start using the [svelte.rr.rc.css.master.co](https://svelte.rr.rc.css.master.co).
        ...
        <StepR>
            ...
            cd __my-project__
            npm install @master/css.svelte@rc
            npm install
            npm run dev -- --open
            ```
        </StepR>
