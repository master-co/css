...
<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            Create a `src/hooks.server.js` and use the `render()` to scan the rendered HTML of the Svelte pages, extract class names, generate CSS rules, and inject the CSS text.
        </StepL>
        <StepR>
