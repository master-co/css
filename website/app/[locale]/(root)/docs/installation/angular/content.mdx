...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the following commands to quickly start using the [example](https://github.com/master-co/css/tree/rc/examples/angular-with-progressive-rendering).
