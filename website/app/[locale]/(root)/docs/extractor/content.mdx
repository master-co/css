...
```bash name=Terminal
npx @master/css extract **index.html** **main.js**
```
...
```bash name=Terminal
npx @master/css extract **--output master.css**
```
...
```bash name=Terminal
npx @master/css extract **--option dir/master.css-extractor.js**
```
...
```bash name=Terminal
npx @master/css extract **--verbose 0**
```
