...
<Image src="/images/no-preload-network.png" alt="Screenshot of Chrome DevTools Network panel" width="841" height="69" />
...
## Solutions
### Preload critical engine
(o) Use `html <link rel="preload" …>` to preload the runtime engine.
...
<Image src="/images/preload-network.png" alt="Screenshot of Chrome DevTools Network panel" width="841" height="69" />
