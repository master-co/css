...
export default function DocSidebar(props: any) {
    ...
    return (
        <aside id="sidebar" className="scrollbar fixed hide@print hide@<lg invisible:not(:hover)::scrollbar-thumb invisible:not(:hover)::scrollbar bd:blur(25)@<lg bg:transparent!::scrollbar bg:gray-10/.9@<lg@dark bg:white/.8@<lg direction:rtl h:calc(100%-6rem-1px) h:calc(100%-3.75rem)@lg left:max(0px,calc(50%-45.3125rem)) overflow-y:overlay!@supports(overflow:overlay) overflow-y:auto overscroll-behavior:contain top:97 top:60@lg w:full w:260@lg w:300@xl z:1050@<lg">
