...
<body>
  <h1 class="italic m:3rem fg-strong font-size:40px font-heavy">Hello World</h1>
</body>
</html>
```
...
## Documentation
Check out the official [CDN installation guide](https://rc.css.master.co/guide/installation/cdn).
