...
<img width="1331" alt="Screenshot 2022-12-17 at 1 21 57 AM" src="https://user-images.githubusercontent.com/33840671/208153990-9e780358-df3f-4c42-9a76-3e26561c3e40.png">

</p>
<p align="center">A vite plugin for integrating Master CSS ahead-of-time compilation with Svelte Kit</p>
...
```
Import the virtual CSS module into `src/routes/+layout.svelte`:
```html
<script>
