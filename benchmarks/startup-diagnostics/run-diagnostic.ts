...
import { runStartupDiagnostic, type StartupDiagnosticToolId } from '../shared/startup-diagnostics'
...
const result = await runStartupDiagnostic({
    ...
    toolId: requireOption(options.toolId, 'tool-id') as StartupDiagnosticToolId,
