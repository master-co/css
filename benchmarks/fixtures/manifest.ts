...
export const benchmarkFixtures = [
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'master-delivery-modes'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'browser-css-cost'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-diagnostics', 'extraction-diagnostics', 'browser-css-cost'],
