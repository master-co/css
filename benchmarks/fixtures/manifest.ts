...
export const benchmarkFixtures = [
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'master-delivery-modes'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'browser-css-cost'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'browser-css-cost'],
