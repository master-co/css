...
export const benchmarkFixtures = [
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'startup-diagnostics', 'master-delivery-modes'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-performance', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'startup-diagnostics', 'browser-css-cost'],
    ...
    },
    {
        ...
        suites: ['css-output-size', 'build-diagnostics', 'extraction-diagnostics', 'compiler-diagnostics', 'startup-diagnostics', 'browser-css-cost'],
