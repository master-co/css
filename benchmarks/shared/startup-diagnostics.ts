...
async function runMasterCLIStartupDiagnostic(workspace: string, fixtureId: BenchmarkFixtureId): Promise<DiagnosticRunResult> {
  ...
  await runImportProbeBatch(workspace, recorder, [
    ...
    ['cli-scanner-import-ms', '@master/css-tooling/scanner', cliPackageFile],
    ['cli-stylesheet-import-ms', '@master/css-compiler/stylesheet', cliPackageFile],
    ['cli-project-entries-import-ms', '@master/css-compiler/project/entries', cliPackageFile],
...
async function runViteImportProbes(workspace: string, recorder: DiagnosticRecorder) {
  ...
  await runImportProbeBatch(workspace, recorder, [
    ...
    ['vite-css-scanner-import-ms', '@master/css-tooling/scanner', vitePackageFile],
    ...
    ['vite-css-project-entries-import-ms', '@master/css-compiler/project/entries', vitePackageFile],
    ['vite-css-integration-node-import-ms', '@master/css-internal-integration/node', vitePackageFile],
...
function renderCLICommanderParseProbe(cliPackageFile: string) {
  return [
    ...
    '    .action(() => {})',
    'await program.parseAsync(["index.html", "-o", "dist/output.css", "-v", "0"], { from: "user" })',
...
function renderCLIRunProgramProbe(coreFile: string) {
  return [
    ...
    'await runProgram(["node", "@master/css", "index.html", "-o", "dist/output.css", "-v", "0"])',
