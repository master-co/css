...
export const interactionCostMetrics = [
    ...
    },
    {
        ...
        unit: 'ms',
        description: 'Instrumented Master CSS runtime add/remove time during the measured interaction, where a runtime exists.'
    },
    {
...
function addRuntimeHarness(html: string, options: {
    ...
    return insertBeforeHeadEnd(withVisibility, [
        ...
        '            const originalAdd = Runtime.prototype.add;',
        '            const originalRemove = Runtime.prototype.remove;',
