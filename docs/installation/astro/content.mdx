<ProgressiveRenderingIntro img={{
    href: "https://astro.pr.beta.css.master.co",
...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the following commands to quickly start using the [astro.pr.beta.css.master.co](https://astro.pr.beta.css.master.co).

            You can skip all [installation](#installation) steps.
        </StepL>
        <StepR>
            ```bash name=Terminal
            npx degit master-co/css/examples/astro-with-progressive-rendering __my-project__
            cd __my-project__
...
<StepSection>
    <Step $row>
        <StepL>
            ...
            If you don't have a Astro project, create one first. It's recommended to refer to [Get started with Astro](https://nuxt.com/docs/getting-started/installation).
        </StepL>
        <StepR>
            ```bash name=Terminal
