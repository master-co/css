...
<StaticExtractionIntro img={{
    href: "https://vite.se.beta.css.master.co",
...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the following commands to quickly start using the [vite.se.beta.css.master.co](https://vite.se.beta.css.master.co).
