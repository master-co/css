...
各位久等了！經過幾週的衝刺，終於迎來穩定的 **Master CSS v2.0.0** 公測版，提前試用的目的是希望集結各位對於新功能的反應、回饋甚至建議來加強版本的通用及穩定，並且在公測期間做最後的修改。
...
- [其他的更動](#其他的更動)
  ...
  - [🔄 升級 VSCode 上的 Master CSS Language Service 擴充到 v2](#-升級-vscode-上的-master-css-language-service-擴充到-v2)
- [更多的 API](#更多的-api)
  - [`render()`](#render)
...
- 🔥 支援模組熱替換 (HMR, Hot Module Replacement)
...
## 🔄 升級 VSCode 上的 Master CSS Language Service 擴充到 v2
...
4. **Master UI 系列**：相信很多人都迫不及待 Master UI 的系列，我們極度講究介面的細節及原始碼的品質，預計於年底釋出基本的開源元件如 `button`, `card`, `tabs` 等。