...
If you want to configure Master CSS in `<head>`, set the global `window.masterCSSConfig` before importing:
```diff
...
<head>
+   <script>
...
...
```
⚠️ Usually you just want to do this for a quick demonstration in HTML.
