...
Assuming that a brand new CSS property of `new-property` has just been launched, you can use it ahead of time through [arbitrarily CSS syntax](/docs/syntax/styles#arbitrary-css-rules) `{}` before we include it in the core rules:
```html
