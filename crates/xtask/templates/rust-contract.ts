...
export const MASTER_CSS_BINDING_ABI_VERSION = {{MASTER_CSS_BINDING_ABI_VERSION}} as const
export const MASTER_CSS_LANGUAGE_VERSION = {{MASTER_CSS_LANGUAGE_VERSION}} as const
export const MASTER_CSS_MANIFEST_VERSION = {{MASTER_CSS_MANIFEST_VERSION}} as const
export const MASTER_CSS_HYDRATION_MANIFEST_VERSION = {{MASTER_CSS_HYDRATION_MANIFEST_VERSION}} as const
export const MASTER_CSS_ENGINE_TRANSITION_VERSION = {{MASTER_CSS_ENGINE_TRANSITION_VERSION}} as const
export const MASTER_CSS_VALIDATOR_BATCH_VERSION = {{MASTER_CSS_VALIDATOR_BATCH_VERSION}} as const
export const MASTER_CSS_DIAGNOSTICS_REPORT_VERSION = {{MASTER_CSS_DIAGNOSTICS_REPORT_VERSION}} as const
export const MASTER_CSS_LINT_BATCH_VERSION = {{MASTER_CSS_LINT_BATCH_VERSION}} as const
export const MASTER_CSS_LANGUAGE_BATCH_VERSION = {{MASTER_CSS_LANGUAGE_BATCH_VERSION}} as const
...
export interface MasterCSSRCMigrationRequest {
  ...
  readonly targetIsPreset?: boolean
  readonly classLists: readonly (readonly string[])[]
  readonly stylesheets?: readonly string[]
  readonly documents?: readonly string[]
}

export interface MasterCSSRCClassMigration {
  readonly before: string
  readonly after: string | null
  readonly status: 'unchanged' | 'replace' | 'review'
...
export interface MasterCSSBindingInfo {
  ...
  languageVersion: typeof MASTER_CSS_LANGUAGE_VERSION
...
export interface MasterCSSInspectionDiagnostic {
  ...
  phase: MasterCSSDiagnostic['phase']
  range?: MasterCSSSourceRange
...
export interface MasterCSSDiagnosticsReportInput {
  ...
  inspections?: readonly MasterCSSValidatedClassInspection[]
  scanner: {
    latent?: readonly string[]
    valid?: readonly string[]
    invalid?: readonly string[]
...
export interface MasterCSSInspectionReport {
  ...
  inspections: MasterCSSValidatedClassInspection[]
