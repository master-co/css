...
project CSS files containing @master; or @import "@master/css"
  ...
  -> compiler parses @theme token/mode directives, @master root options, top-level @custom-at/@custom-selector definitions, top-level managed layers, and top-level keyframes
