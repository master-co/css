...
rows=[]
for mode in ['pure-runtime','runtime','progressive']:
 for request in ['runtime','css-runtime','html-css-runtime']:
...
Path('.ai/audits/bug-hunt/evidence/0158-pure-runtime-matrix.json').write_text(json.dumps(rows,indent=2)+'\n')
