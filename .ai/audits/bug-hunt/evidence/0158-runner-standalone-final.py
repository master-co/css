...
for dependency,hot,optimizer in itertools.product(['0'],['1'],['on','off']):
 env={**os.environ,'BH_DEPENDENCY':dependency,'BH_HOT':hot,'BH_OPTIMIZER':optimizer,'BH_FULL':'1'}
...
Path('.ai/audits/bug-hunt/evidence/0158-standalone-final-matrix.json').write_text(json.dumps(rows,indent=2)+'\n')
