...
rows=[]
for mode in ['pure','static','runtime','pre-render','progressive']:
 for request in ['none','html','css','runtime','css-runtime','html-css-runtime']:
  env={**os.environ,'BH_MODE':mode,'BH_REQUEST':request}
...
Path('.ai/audits/bug-hunt/evidence/0158-mode-request-matrix.json').write_text(json.dumps(rows,indent=2)+'\n')
