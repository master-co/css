...
| BH-0053 | P1 | 部分修正 | Next/Turbopack 在 Sass 預處理前分類造成編譯失敗 | raw Sass、partial reference／diagnostic／缺檔恢復已驗；output／entry map、additionalData offsets及完整host/options待驗；[檢查](evidence/0183-next-raw-final-checks.json) |
